...
.field private e:Ljac;


# direct methods
.method public constructor <init>(Ljava/lang/String;I[Liph;Ljdt;Ljac;)V
    .locals 0
    ...
    iput-object p3, p0, Liqf;->d:[Liph;

    iput-object p4, p0, Liqf;->c:Ljdt;

    iput-object p5, p0, Liqf;->e:Ljac;

    return-void
.end method

.method private final a(Ljao;Ljava/util/List;Liph;F)Ljava/util/List;
    .locals 23

    move-object/from16 v0, p3

    iget-object v4, v0, Liph;->f:Ljava/util/List;
    ...
    :goto_0
    invoke-static {v4}, Lixp;->a(Z)V

    move-object/from16 v0, p3

    iget-object v6, v0, Liph;->f:Ljava/util/List;
    ...
    invoke-virtual/range {p1 .. p1}, Ljao;->a()I
    ...
    iget-object v6, v0, Ljao;->a:Ljava/util/List;

    invoke-static {v6}, Ljkk;->a(Ljava/util/Collection;)Ljkk;
    ...
    iget-object v4, v0, Liqf;->c:Ljdt;

    invoke-virtual {v4, v6, v7}, Ljdt;->a(J)Ljdh;

    move-result-object v4

    sget-object v19, Ljdh;->p:Ljdp;

    move-object/from16 v0, v19

    invoke-virtual {v4, v0}, Ljdh;->b(Ljdp;)Z
    ...
    sget-object v9, Ljdh;->p:Ljdp;

    invoke-virtual {v4, v9}, Ljdh;->a(Ljdp;)Ljava/lang/Object;
    ...
    iget-object v5, v0, Liph;->f:Ljava/util/List;
    ...
    invoke-direct/range {v4 .. v9}, Liqz;-><init>(Lipj;JLandroid/graphics/RectF;Landroid/graphics/RectF;)V
...
.method public final a(Ljao;Ljava/util/concurrent/Executor;)Liku;
    ...
    invoke-direct {v5, v0, v3}, Liqh;-><init>(FI)V
    ...
    iget-object v1, v3, Liph;->f:Ljava/util/List;
    ...
    iget-object v1, v3, Liph;->d:Lipi;

    if-ne v1, v2, :cond_6

    iget-object v1, v3, Liph;->e:Ljava/util/List;
    ...
    invoke-direct {p0, p1, v7, v3, v6}, Liqf;->a(Ljao;Ljava/util/List;Liph;F)Ljava/util/List;
    ...
    iget-object v1, p0, Liqf;->a:Ljava/lang/String;
    ...
    invoke-direct {v3, v0, v1}, Liqg;-><init>(Liph;Ljava/util/List;)V

    new-instance v1, Liqb;

    iget-object v2, v3, Liqg;->a:Liph;

    iget-object v3, v3, Liqg;->b:Ljava/util/List;

    iget-object v4, p0, Liqf;->a:Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v7}, Liqb;-><init>(Liph;Ljava/util/List;Ljava/lang/String;IJ)V
