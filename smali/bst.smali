...
.method public constructor <init>(Lhae;Landroid/content/res/Resources;Lcom/google/android/apps/camera/legacy/app/stats/CameraActivitySession;Lidb;Lesn;Lcom/google/android/apps/camera/legacy/app/stats/Instrumentation;Lbqm;Lgsf;Lija;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, v0}, Lbvs;-><init>(Lflf;)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lbst;->l:Z
    ...
    iput-object v0, p0, Lbst;->e:Landroid/content/res/Resources;
    ...
    iput-object v0, p0, Lbst;->f:Lcom/google/android/apps/camera/legacy/app/stats/CameraActivitySession;
    ...
    iput-object v0, p0, Lbst;->h:Lcom/google/android/apps/camera/legacy/app/stats/Instrumentation;
...
.method private final f()I
    ...
    iget-object v2, p0, Lbst;->e:Landroid/content/res/Resources;
...
.method public final c()V
    ...
    :cond_0
    iget-boolean v1, p0, Lbst;->l:Z

    if-nez v1, :cond_1

    iget-object v1, p0, Lbst;->f:Lcom/google/android/apps/camera/legacy/app/stats/CameraActivitySession;
    ...
    invoke-static {v5, v8}, Lbhy;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    iput-wide v6, p0, Lbst;->m:J

    iget-object v1, p0, Lbst;->g:Lidb;

    invoke-interface {v1}, Lidb;->a()J

    iget-object v1, p0, Lbst;->d:Lhae;
    ...
    iget-object v4, p0, Lbst;->d:Lhae;

    invoke-virtual {v4}, Lhae;->a()Landroid/content/Intent;
    ...
    :goto_3
    iget-object v0, p0, Lbst;->i:Lbqm;

    iget-object v0, v0, Lbqm;->a:Landroid/content/Context;

    const-string v3, "keyguard"

    invoke-static {v0, v3}, Lbqm;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lbst;->g:Lidb;

    invoke-direct {p0}, Lbst;->f()I
    ...
    iget-boolean v6, p0, Lbst;->l:Z

    invoke-interface/range {v0 .. v6}, Lidb;->a(IIIZZZ)V
...
.method public final d()V
    ...
    iget-wide v0, v2, Lfsm;->f:J

    cmp-long v0, v0, v6

    if-eqz v0, :cond_1

    iget-wide v0, v2, Lfsm;->e:J
    ...
    iget-object v2, p0, Lbst;->h:Lcom/google/android/apps/camera/legacy/app/stats/Instrumentation;
    ...
    invoke-static {v2}, Lesn;->a(Ljava/util/List;)[Ljqv;

    move-result-object v2

    invoke-interface {v0, v1, v2, v3}, Lidb;->a(I[Ljqv;Lcom/google/common/logging/nano/eventprotos$LaunchReport;)V

    goto :goto_0

    :cond_3
    iget-wide v0, v2, Lfsm;->b:J
    :try_end_0
