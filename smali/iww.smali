...
.method public static a(Liwv;Ljava/lang/String;Landroid/graphics/Bitmap;)Liwy;
    .locals 7
    ...
    invoke-static/range {v0 .. v6}, Liww;->a(Liwv;Ljava/lang/String;Landroid/graphics/Bitmap;IILandroid/graphics/Matrix;Z)Liwy;
...
.method public static a(Liwv;Ljava/lang/String;Landroid/graphics/Bitmap;II)Liwy;
    .locals 7
    ...
    :try_start_0
    sget-object v5, Liww;->a:Landroid/graphics/Matrix;

    const/4 v0, 0x0

    sput-object v0, Liww;->a:Landroid/graphics/Matrix;
    ...
    :try_start_1
    sget-object v2, Liww;->a:Landroid/graphics/Matrix;

    if-nez v2, :cond_1

    sput-object v5, Liww;->a:Landroid/graphics/Matrix;
...
.method private static a(Liwv;Ljava/lang/String;Landroid/graphics/Bitmap;IILandroid/graphics/Matrix;Z)Liwy;
    .locals 9
    ...
    :cond_5
    invoke-interface {p0, p1, p3, p4, v2}, Liwv;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liwy;
    ...
    :goto_3
    invoke-interface {p0, p1, v7, v8, v0}, Liwv;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liwy;
...
.method public static a(Liwv;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Liwy;
    .locals 6
    ...
    invoke-interface {p0, v0, v1}, Liwv;->a(Ljava/lang/String;Landroid/graphics/Bitmap;)Liwy;
    ...
    invoke-static {v1, v0}, Liww;->a(Landroid/graphics/Bitmap;Liwy;)V

    invoke-static {v0, v2, v3}, Liww;->a(Liwy;II)V

    invoke-static {v0, v4}, Liww;->a(Liwy;Landroid/graphics/Bitmap$Config;)V
    ...
    :cond_3
    invoke-interface {p0, v0, v2, v3, v4}, Liwv;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liwy;
...
.method public static a(Liwv;Ljava/lang/String;Landroid/graphics/Rect;)Liwy;
    .locals 5
    ...
    invoke-interface {p0, v0, v3, v4, v2}, Liwv;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liwy;
    ...
    invoke-static {v1, v3}, Liww;->a(Landroid/graphics/Bitmap;Liwy;)V
    ...
    invoke-static {v3, v0, v1}, Liww;->a(Liwy;II)V

    invoke-static {v3, v2}, Liww;->a(Liwy;Landroid/graphics/Bitmap$Config;)V
    :try_end_0
...
.method public static a(Liwv;Ljava/lang/String;Liwy;II)Liwy;
    .locals 1

    invoke-interface {p2}, Liwy;->e()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/graphics/Bitmap;

    invoke-static {p0, p1, v0, p3, p4}, Liww;->a(Liwv;Ljava/lang/String;Landroid/graphics/Bitmap;II)Liwy;
...
.method public static a(Liwv;Ljava/lang/String;Ljava/nio/ByteBuffer;II)Liwy;
    .locals 2

    sget-object v0, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-interface {p0, p1, p3, p4, v0}, Liwv;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liwy;
...
.method public static a(Liwv;Ljfw;Ljava/lang/String;)Liwy;
    .locals 4
    ...
    invoke-interface {p0, p2, v0, v1, v2}, Liwv;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liwy;
...
.method private static a(Landroid/graphics/Bitmap;Liwy;)V
    .locals 5

    invoke-interface {p1}, Liwy;->e()Ljava/lang/Object;
...
.method private static a(Liwy;II)V
    .locals 5

    invoke-interface {p0}, Liwy;->e()Ljava/lang/Object;
...
.method private static a(Liwy;Landroid/graphics/Bitmap$Config;)V
    .locals 5
