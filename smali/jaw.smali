...
.method public constructor <init>(Lcom/google/android/libraries/smartburst/buffers/FeatureTable;)V
    ...
    iput-object p1, p0, Ljaw;->a:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;
...
# virtual methods
.method public final a(Ljao;)Ljava/util/Set;
    .locals 9
    ...
    iget-object v0, p0, Ljaw;->a:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;

    iget-object v2, p0, Ljaw;->a:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;

    invoke-interface {v2}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getEarliestTimestamp()J

    move-result-wide v2

    invoke-interface {v0, v2, v3}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getRowIterator(J)Liri;
    ...
    invoke-virtual {v0, v6}, Lirh;->a(Ljfh;)Lcom/google/android/libraries/smartburst/utils/Feature;
    ...
    sget-object v0, Ljap;->b:Ljap;

    const/4 v1, 0x0

    new-array v1, v1, [Ljap;

    invoke-static {v0, v1}, Litx;->a(Ljava/lang/Enum;[Ljava/lang/Enum;)Ljkt;
