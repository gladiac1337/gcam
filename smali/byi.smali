...
# direct methods
.method constructor <init>(Lbyf;Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;)V
    .locals 0

    iput-object p1, p0, Lbyi;->b:Lbyf;

    iput-object p2, p0, Lbyi;->a:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;
...
.method public final onPreDraw()Z
    ...
    iget-object v1, p0, Lbyi;->b:Lbyf;

    iget-object v2, p0, Lbyi;->a:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;

    iget-object v0, v1, Lbyf;->b:Ljava/util/List;

    iget-object v3, v1, Lbyf;->l:Landroid/support/v4/view/ViewPager;
    ...
    invoke-virtual {v1, v2, v0}, Lbyf;->a(Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;Lixr;)Lbyr;

    move-result-object v3

    iput-object v3, v1, Lbyf;->g:Lbyr;

    new-instance v4, Landroid/animation/AnimatorSet;

    invoke-direct {v4}, Landroid/animation/AnimatorSet;-><init>()V

    iput-object v4, v1, Lbyf;->d:Landroid/animation/Animator;
    ...
    invoke-direct {v6, v0, v3}, Lbye;-><init>(Lixr;Lbyr;)V
    ...
    iget-object v6, v1, Lbyf;->f:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v6, v1, Lbyf;->i:Landroid/view/View;
    ...
    invoke-direct {v3, v1, v2, v0}, Lbyj;-><init>(Lbyf;Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;Lixr;)V
    ...
    iget-object v0, v0, Lbyf;->l:Landroid/support/v4/view/ViewPager;
