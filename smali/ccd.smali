...
# direct methods
.method public constructor <init>(Lcch;Landroid/widget/FrameLayout;Lccb;)V
    .locals 4

    .prologue
    .line 1
    invoke-direct {p0, p2}, Lccc;-><init>(Landroid/widget/FrameLayout;)V

    .line 3
    iget-object v0, p1, Lcch;->c:Lcny;

    .line 4
    iput-object v0, p0, Lccd;->t:Lcny;

    .line 5
    iput-object p2, p0, Lccd;->u:Landroid/widget/FrameLayout;
    ...
    iput-object v0, p0, Lccd;->r:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;
    ...
    iput-object v0, p0, Lccd;->v:Landroid/widget/FrameLayout;

    .line 9
    iget-object v0, p0, Lccd;->r:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;

    new-instance v1, Lcce;

    invoke-direct {v1, p0, p3}, Lcce;-><init>(Lccd;Lccb;)V
    ...
    invoke-direct {v1, p0, p3}, Lccf;-><init>(Lccd;Lccb;)V
    ...
    iput-object v0, p0, Lccd;->w:Landroid/animation/ValueAnimator;

    .line 17
    iget-object v0, p0, Lccd;->w:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v1, p0}, Lccg;-><init>(Lccd;)V
...
.method static synthetic a(Lccd;)Lcny;
    .locals 1

    .prologue
    .line 95
    iget-object v0, p0, Lccd;->t:Lcny;
...
.method final a(F)V
    ...
    .line 46
    iget-object v1, p0, Lccd;->v:Landroid/widget/FrameLayout;
    ...
    .line 48
    iget-object v0, p0, Lccd;->v:Landroid/widget/FrameLayout;
...
.method public final a(Ladj;Lcdv;)V
    .locals 7
    ...
    .line 57
    iget-object v3, p2, Lcfp;->c:Lcfn;

    .line 58
    iget-object v3, v3, Lcfa;->e:Lfvf;

    .line 59
    iget-object v3, v3, Lfvf;->d:Ljava/lang/String;

    .line 61
    iget-object v4, p2, Lcfp;->c:Lcfn;

    .line 62
    iget-object v4, v4, Lcfa;->e:Lfvf;

    .line 63
    iget-object v4, v4, Lfvf;->f:Ljava/util/Date;
    ...
    invoke-static {v3, v0}, Laoy;->a(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v0, v1}, Laoy;->a(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 84
    iget-object v0, p0, Lccd;->p:Landroid/net/Uri;
    ...
    .line 86
    iput-object v0, p0, Lccd;->s:Ladg;

    .line 87
    iget-object v0, p0, Lccd;->s:Ladg;

    iget-object v1, p0, Lccd;->r:Lcom/google/android/apps/camera/legacy/app/burst/editor/grid/BurstImageView;
...
.method public final b(Z)V
    ...
    .line 23
    iget-object v3, p0, Lccd;->p:Landroid/net/Uri;

    .line 24
    invoke-virtual {v0, v3}, Lcny;->a(Landroid/net/Uri;)Z

    move-result v3

    .line 25
    iget-object v0, p0, Lccd;->u:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {p0, v0}, Lccd;->a(F)V
    ...
    .line 40
    :cond_4
    invoke-virtual {p0, v5}, Lccd;->a(F)V
