...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhgk;->j:[Labz;

    new-instance v0, Lhgl;

    invoke-direct {v0}, Lhgl;-><init>()V

    sput-object v0, Lhgk;->m:Ljava/util/Comparator;

    return-void
.end method

.method public constructor <init>(Lbtw;Landroid/os/Handler;Labe;I)V
    .locals 10
    ...
    iput-object v0, p0, Lhgk;->b:Labe;

    iput-object v0, p0, Lhgk;->c:Lace;

    iput-boolean v2, p0, Lhgk;->d:Z

    iput-object v0, p0, Lhgk;->e:Lhgn;

    iput-object v0, p0, Lhgk;->k:Lcom/google/android/apps/refocus/image/ColorImage;

    iput-object p1, p0, Lhgk;->g:Lbtw;

    iput-object p2, p0, Lhgk;->h:Landroid/os/Handler;

    iput-object p3, p0, Lhgk;->b:Labe;

    invoke-virtual {p3}, Labe;->g()Lacl;

    move-result-object v0

    iput-object v0, p0, Lhgk;->f:Lacl;

    invoke-virtual {p3}, Labe;->c()Labw;

    move-result-object v0

    iput-object v0, p0, Lhgk;->l:Labw;

    iget-object v0, p0, Lhgk;->b:Labe;
    ...
    iget-object v0, p0, Lhgk;->l:Labw;

    iget-object v3, p0, Lhgk;->f:Lacl;
    ...
    sget-object v6, Lhgk;->a:Ljava/lang/String;

    const-string v7, "preview formats:\n"

    invoke-static {v4}, Lhgk;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    :goto_0
    invoke-static {v6, v0}, Lbhy;->a(Ljava/lang/String;Ljava/lang/String;)V

    sget-object v6, Lhgk;->a:Ljava/lang/String;

    const-string v7, "picture formats:\n"

    invoke-static {v5}, Lhgk;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    sget-object v0, Lhgk;->m:Ljava/util/Comparator;
    ...
    new-instance v6, Lhgp;

    invoke-direct {v6, p4}, Lhgp;-><init>(I)V

    invoke-direct {v0, v6}, Lhgo;-><init>(Lhgp;)V

    invoke-virtual {v0, v4, v5}, Lhgo;->a(Ljava/util/List;Ljava/util/List;)[Lact;
    ...
    invoke-static {v0, v3}, Lhgk;->a(Labw;Lacl;)V
    ...
    iput-object v0, p0, Lhgk;->i:Ljava/lang/Object;
    ...
    :cond_5
    sget-object v4, Lhgk;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v5}, Lbhy;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a(Labq;)V
    ...
    iget-object v1, p0, Lhgk;->i:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v0, p0, Lhgk;->d:Z
    ...
    iget-object v2, p0, Lhgk;->h:Landroid/os/Handler;
...
.method public final a(Landroid/graphics/SurfaceTexture;Labq;)V
    ...
    invoke-virtual {p0, p2}, Lhgk;->a(Labq;)V
...
.method public final a([BLabe;)V
    ...
    :cond_1
    iget-object v0, p0, Lhgk;->k:Lcom/google/android/apps/refocus/image/ColorImage;

    invoke-virtual {v0, p1}, Lcom/google/android/apps/refocus/image/ColorImage;->setBuffer([B)V

    iget-object v0, p0, Lhgk;->e:Lhgn;

    iget-object v1, p0, Lhgk;->k:Lcom/google/android/apps/refocus/image/ColorImage;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtimeNanos()J

    move-result-wide v2

    invoke-interface {v0, v1, v2, v3}, Lhgn;->a(Lcom/google/android/apps/refocus/image/ColorImage;J)V
