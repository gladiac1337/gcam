...
# direct methods
.method constructor <init>(Lflp;IZ)V
    .locals 0
...
.method public final run()V
    ...
    iget-boolean v2, p0, Lflr;->c:Z

    invoke-static {}, Lhzi;->a()V

    new-instance v3, Landroid/app/AlertDialog$Builder;

    iget-object v4, v0, Lflp;->a:Landroid/app/Activity;

    const v5, 0x10302d2

    invoke-direct {v3, v4, v5}, Landroid/app/AlertDialog$Builder;-><init>(Landroid/content/Context;I)V

    iget-object v4, v0, Lflp;->c:Landroid/content/res/Resources;
    ...
    invoke-direct {v3, v0}, Lfls;-><init>(Lflp;)V
    ...
    iget-object v2, v0, Lflp;->c:Landroid/content/res/Resources;

    invoke-virtual {v2, v6}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v2

    iget-object v0, v0, Lflp;->e:Landroid/content/DialogInterface$OnClickListener;
    ...
    invoke-direct {v3, v0}, Lflt;-><init>(Lflp;)V

    invoke-virtual {v1, v2, v3}, Landroid/app/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    move-result-object v2

    iget-object v3, v0, Lflp;->c:Landroid/content/res/Resources;
