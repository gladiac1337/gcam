...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgua;->a:Ljava/util/concurrent/locks/ReentrantLock;

    const/4 v0, 0x0

    sput-object v0, Lgua;->b:Landroid/support/v8/renderscript/RenderScript;

    const-string v0, "camera.renderscript"

    sput-object v0, Lgua;->c:Ljava/lang/String;
    ...
    sput-object v0, Lgua;->e:Ljava/lang/String;
...
.method public static a(Landroid/content/Context;)Landroid/support/v8/renderscript/RenderScript;
    ...
    sget-object v1, Lhod;->a:Lhoc;

    sget-object v3, Lgua;->c:Ljava/lang/String;

    invoke-virtual {v1, v3}, Lhoc;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-static {v3}, Lile;->a(Ljava/lang/String;)Z
    ...
    sget-object v1, Lgua;->d:Ljava/lang/String;
    ...
    sget-object v1, Lgua;->e:Ljava/lang/String;
    ...
    :cond_2
    sget-object v1, Lgua;->a:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :cond_3
    sget-object v0, Lgua;->b:Landroid/support/v8/renderscript/RenderScript;
    ...
    :cond_4
    sget-object v0, Lgua;->e:Ljava/lang/String;
