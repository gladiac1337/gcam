...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcpv;->i:Landroid/net/Uri;

    return-void
.end method

.method constructor <init>(Landroid/content/Context;Lcqb;)V
    .locals 3
    ...
    iput-boolean v0, p0, Lcpv;->f:Z

    iput-object p2, p0, Lcpv;->h:Lcqb;

    new-instance v0, Lgzr;

    new-instance v1, Lhkb;

    invoke-direct {v1, p1}, Lhkb;-><init>(Landroid/content/Context;)V

    sget-object v2, Lhtw;->a:Lhjr;
    ...
    invoke-static {p0, v2}, Lhiv;->b(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v2, v1, Lhkb;->b:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lhkb;->c:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcpv;->b:Lgzr;

    iput-object p1, p0, Lcpv;->d:Landroid/content/Context;
...
.method static a(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcpv;->b(Landroid/content/Context;)I
...
.method private static b(Landroid/content/Context;)I
    ...
    :try_start_0
    sget-object v1, Lcpv;->i:Landroid/net/Uri;
    ...
    :goto_2
    :try_start_2
    sget-object v2, Lcpv;->a:Ljava/lang/String;
...
.method public final a(Z)Ljuk;
    ...
    invoke-direct {v1, p0, v0, p1}, Lcpw;-><init>(Lcpv;Ljuw;Z)V

    const/4 v2, 0x0

    new-array v2, v2, [Ljava/lang/Void;

    invoke-virtual {v1, v2}, Lcpw;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public final a(Lcom/google/android/gms/common/ConnectionResult;)V
    ...
    iget-object v0, v0, Lcqb;->a:Lcqd;

    invoke-virtual {v0}, Lcqd;->e()V
...
.method public final b()Landroid/location/Location;
    ...
    iget-object v1, v1, Lgzt;->a:Lgzr;

    iget-object v1, v1, Lgzr;->a:Lhka;

    invoke-static {v1}, Lhts;->a(Lhka;)Landroid/location/Location;
...
.method final c()V
    ...
    iget-boolean v0, p0, Lcpv;->f:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcpv;->c:Lgzt;
    ...
    invoke-direct {v1, v0, p0}, Lhud;-><init>(Lhka;Lhtv;)V

    invoke-virtual {v0, v1}, Lhka;->b(Lhrn;)Lhrn;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    :cond_0
    :goto_0
    iput-boolean v3, p0, Lcpv;->f:Z

    iput-boolean v3, p0, Lcpv;->e:Z
