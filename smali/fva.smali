...
.method public static a(Lxb;)Ljava/lang/String;
    ...
    .line 122
    sget-object v2, Lfva;->a:Ljava/lang/String;
...
.method private static a(Lfve;Z)Ljava/util/List;
    .locals 7
    ...
    :cond_0
    :try_start_1
    invoke-interface {p0}, Lfve;->close()V
    :try_end_1
    ...
    .line 202
    :try_start_6
    invoke-interface {p0, v2}, Lfve;->a(I)Lfvd;
    ...
    :try_start_a
    invoke-interface {p0, v3, v2}, Lfve;->a(II)Lfvd;
    ...
    invoke-static {v2, v3, v1}, Lbhz;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_b
    ...
    :try_start_d
    invoke-interface {p0, v2}, Lfve;->b(I)V
    :try_end_d
...
.method private static a(Ljava/util/List;Lxb;)Ljava/util/List;
    ...
    invoke-static {v2, v3, v0}, Lbhz;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v5, v1, v7, v3, v2}, Lfvd;-><init>([BIII)V
    ...
    invoke-static {v1}, Lfva;->a(Lfvd;)Z
...
.method public static a(Ljava/io/InputStream;)Lxb;
    ...
    invoke-direct {v0, p0}, Lfvc;-><init>(Ljava/io/InputStream;)V

    const/4 v1, 0x1

    invoke-static {v0, v1}, Lfva;->a(Lfve;Z)Ljava/util/List;
    ...
    .line 17
    sget-object v0, Lfva;->a:Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v0}, Lfva;->a(Ljava/util/List;)Lxb;
...
.method public static a(Ljava/lang/String;)Lxb;
    ...
    .line 5
    :try_start_1
    invoke-static {v3}, Lfva;->a(Ljava/io/InputStream;)Lxb;
    :try_end_1
    ...
    .line 10
    sget-object v3, Lfva;->a:Ljava/lang/String;
...
.method private static a(Ljava/util/List;)Lxb;
    ...
    .line 21
    invoke-static {v0}, Lfva;->a(Lfvd;)Z
    ...
    .line 35
    sget-object v1, Lfva;->a:Ljava/lang/String;

    const-string v3, "XMP parse error"

    invoke-static {v1, v3, v0}, Lbhz;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static a(Lfvd;)Z
    .locals 6
...
.method public static a(Ljava/io/InputStream;Ljava/io/OutputStream;Lxb;)Z
    ...
    invoke-static {v0, p1, p2}, Lfva;->a([BLjava/io/OutputStream;Lxb;)Z
    :try_end_0
...
.method public static a(Ljava/lang/String;Lxb;)Z
    ...
    invoke-direct {v0, v3}, Lfvc;-><init>(Ljava/io/InputStream;)V

    const/4 v4, 0x0

    invoke-static {v0, v4}, Lfva;->a(Lfve;Z)Ljava/util/List;

    move-result-object v0

    .line 49
    invoke-static {v0, p1}, Lfva;->a(Ljava/util/List;Lxb;)Ljava/util/List;
    :try_end_1
    ...
    .line 64
    :try_start_4
    invoke-static {v3, v0}, Lfva;->a(Ljava/io/OutputStream;Ljava/util/List;)V
    :try_end_4
    ...
    :goto_6
    :try_start_b
    sget-object v4, Lfva;->a:Ljava/lang/String;
    ...
    :goto_7
    invoke-static {v4, v3, v0}, Lbhz;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_b
...
.method public static a([BLjava/io/OutputStream;Lxb;)Z
    ...
    invoke-direct {v1, p0}, Lfvb;-><init>([B)V

    invoke-static {v1, v0}, Lfva;->a(Lfve;Z)Ljava/util/List;

    move-result-object v1

    .line 83
    invoke-static {v1, p2}, Lfva;->a(Ljava/util/List;Lxb;)Ljava/util/List;
    ...
    :cond_1
    :try_start_0
    invoke-static {p1, v1}, Lfva;->a(Ljava/io/OutputStream;Ljava/util/List;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
