...
# direct methods
.method public constructor <init>(Lcom/google/android/libraries/smartburst/buffers/FeatureTable;Lifo;)V
    .locals 1

    .prologue
    .line 1
    invoke-direct {p0}, Lies;-><init>()V

    .line 2
    iput-object p2, p0, Lifp;->a:Lifo;

    .line 3
    iput-object p1, p0, Lifp;->b:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;
...
# virtual methods
.method public final a(Liel;)Ljava/util/List;
    .locals 14
    ...
    .line 13
    :cond_0
    iget-object v0, p0, Lifp;->b:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;
    ...
    .line 18
    iget-object v5, p0, Lifp;->b:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;

    sget-object v8, Lije;->c:Lije;

    .line 19
    invoke-interface {v5, v6, v7, v8}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getFeature(JLije;)Lcom/google/android/libraries/smartburst/utils/Feature;
    ...
    iget-object v5, p0, Lifp;->a:Lifo;

    iget v6, p0, Lifp;->c:F

    iget v7, p0, Lifp;->d:F

    invoke-direct/range {v0 .. v7}, Lifq;-><init>([F[F[JLjava/util/List;Lifo;FF)V
    ...
    .line 64
    iget-object v5, v0, Lifq;->b:[J

    iget-object v6, v0, Lifq;->b:[J
    ...
    invoke-virtual {v0, v2, v7}, Lifq;->a(II)D
    ...
    invoke-virtual {v0, v8, v7}, Lifq;->a(II)D
    ...
    .line 80
    iget-object v1, v0, Lifq;->c:Ljava/util/List;

    iget-object v0, v0, Lifq;->b:[J

    const/4 v2, 0x0

    aget-wide v4, v0, v2

    invoke-static {v1, v3, v4, v5}, Lifq;->a(Ljava/util/List;Ljava/util/Deque;J)Ljava/util/List;
