...
.method final a(Ljava/util/List;Landroid/preference/ListPreference;)V
    ...
    invoke-static {v0}, Leqx;->b(Libx;)Libx;
    ...
    invoke-static {v5}, Leqx;->a(Libx;)I

    move-result v7

    invoke-static {v5}, Leqx;->c(Libx;)I
    ...
    invoke-static {v0}, Liby;->a(Libx;)Ljava/lang/String;
...
.method public final onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v1}, Leqs;->a(Lift;)Ljava/util/List;

    move-result-object v1

    sget-object v2, Lift;->a:Lift;

    invoke-virtual {v0, v2}, Leqs;->a(Lift;)Ljava/util/List;

    move-result-object v2

    sget-object v3, Lift;->b:Lift;

    invoke-virtual {v0, v3}, Leqs;->b(Lift;)Ljhi;

    move-result-object v3

    sget-object v4, Lift;->a:Lift;

    invoke-virtual {v0, v4}, Leqs;->b(Lift;)Ljhi;

    move-result-object v0

    new-instance v4, Leqt;

    invoke-direct {v4, v1, v2, v3, v0}, Leqt;-><init>(Ljava/util/List;Ljava/util/List;Ljhi;Ljhi;)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p0}, Ldig;->a(Leqh;)V

    new-instance v0, Lhzg;

    invoke-direct {v0}, Lhzg;-><init>()V

    iput-object v0, p0, Leqh;->t:Lhzg;
    ...
    :cond_0
    :goto_1
    iget-object v2, p0, Leqh;->t:Lhzg;

    iget-object v3, p0, Leqh;->j:Liaj;

    new-instance v12, Leqg;

    invoke-direct {v12, p0}, Leqg;-><init>(Leqh;)V

    iget-object v13, p0, Leqh;->g:Lhzi;

    invoke-interface {v3, v12, v13}, Liaj;->a(Licc;Ljava/util/concurrent/Executor;)Libw;
    ...
    iget-object v4, p0, Leqh;->e:Lbiq;

    iput-object v0, v4, Lbiq;->n:Landroid/preference/PreferenceScreen;

    sget-object v0, Lbio;->c:Lbla;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbla;)Landroid/preference/Preference;

    sget-object v0, Lbio;->d:Lbla;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbla;)Landroid/preference/Preference;

    move-result-object v0

    sget-object v2, Lbio;->c:Lbla;

    iget-object v2, v2, Lbky;->b:Ljava/lang/String;
    ...
    iget-object v5, v4, Lbiq;->n:Landroid/preference/PreferenceScreen;
    ...
    iget-object v5, v4, Lbiq;->c:Landroid/content/SharedPreferences;
    ...
    invoke-direct {v0, v4, v2}, Lbir;-><init>(Lbiq;Ljava/lang/String;)V
    ...
    sget-object v0, Lbio;->e:Lbla;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbla;)Landroid/preference/Preference;

    iget-object v0, v4, Lbiq;->m:Lbio;

    iget-object v0, v0, Lbio;->u:Lbkt;

    iget-object v3, v0, Lbky;->b:Ljava/lang/String;

    iget-object v0, v4, Lbiq;->d:Lblh;

    iget-object v2, v4, Lbiq;->m:Lbio;

    iget-object v2, v2, Lbio;->u:Lbkt;

    invoke-virtual {v0, v2}, Lblh;->a(Lbky;)Z

    move-result v0

    if-nez v0, :cond_6

    iget-boolean v0, v4, Lbiq;->o:Z
    ...
    :goto_2
    iget-object v2, v4, Lbiq;->d:Lblh;

    iget-object v5, v4, Lbiq;->m:Lbio;

    iget-object v5, v5, Lbio;->u:Lbkt;

    invoke-virtual {v2, v5}, Lblh;->a(Lbkt;)Z

    move-result v2

    if-eqz v2, :cond_b

    iget-boolean v2, v4, Lbiq;->o:Z
    ...
    :goto_3
    invoke-virtual {v4, v3, v0, v2}, Lbiq;->a(Ljava/lang/String;ZZ)Landroid/preference/Preference;

    iget-object v0, v4, Lbiq;->m:Lbio;

    iget-object v0, v0, Lbio;->v:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    sget-object v0, Lbio;->f:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    sget-object v0, Lbio;->i:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    sget-object v0, Lbio;->j:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    sget-object v0, Lbdn;->a:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    sget-object v0, Lbdn;->b:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    sget-object v0, Lbio;->p:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    sget-object v0, Lbio;->q:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    sget-object v0, Lbio;->r:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    sget-object v0, Lbio;->s:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    const-string v0, "camera:gcam_enabled"

    iget-object v2, v4, Lbiq;->b:Lbhm;

    invoke-virtual {v2}, Lbhm;->d()Z

    move-result v2

    new-instance v3, Lbit;

    iget-object v5, v4, Lbiq;->a:Landroid/content/Context;

    invoke-direct {v3, v5, v0}, Lbit;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v2}, Lbit;->setChecked(Z)V

    :cond_7
    sget-object v0, Lbio;->o:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    iget-object v0, v4, Lbiq;->l:Lgzo;
    ...
    sget-object v0, Lbio;->m:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    sget-object v0, Lbio;->n:Lbkt;

    invoke-virtual {v4, v0}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;

    move-result-object v0

    sget-object v2, Lbio;->m:Lbkt;

    iget-object v2, v2, Lbky;->b:Ljava/lang/String;

    invoke-virtual {v0, v2}, Landroid/preference/Preference;->setDependency(Ljava/lang/String;)V

    sget-object v0, Lbio;->l:Lble;

    invoke-virtual {v4, v0}, Lbiq;->a(Lble;)Landroid/preference/Preference;
    ...
    iget-object v2, v4, Lbiq;->e:Ljava/util/Set;

    invoke-interface {v0, v2}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    iget-object v2, v4, Lbiq;->f:Ljava/util/Set;

    invoke-interface {v0, v2}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    iget-object v2, v4, Lbiq;->g:Ljava/util/Set;

    invoke-interface {v0, v2}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    iget-object v2, v4, Lbiq;->h:Ljava/util/Set;

    invoke-interface {v0, v2}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    iget-object v2, v4, Lbiq;->i:Ljava/util/Set;

    invoke-interface {v0, v2}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    iget-object v2, v4, Lbiq;->j:Ljava/util/Set;

    invoke-interface {v0, v2}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    iget-object v2, v4, Lbiq;->k:Ljava/util/Set;
    ...
    instance-of v7, v2, Lbla;

    if-eqz v7, :cond_c

    check-cast v2, Lbla;

    invoke-virtual {v4, v2}, Lbiq;->a(Lbla;)Landroid/preference/Preference;
    ...
    iget-object v7, v2, Lbky;->b:Ljava/lang/String;

    iget-object v12, v4, Lbiq;->d:Lblh;

    invoke-virtual {v12, v2}, Lblh;->a(Lbky;)Z

    move-result v2

    invoke-virtual {v4, v7, v2, v9}, Lbiq;->a(Ljava/lang/String;ZZ)Landroid/preference/Preference;
    ...
    invoke-virtual {v4, v7, v2, v6}, Lbiq;->a(Ljava/lang/String;ZZ)Landroid/preference/Preference;
    ...
    invoke-virtual {v4, v2}, Lbiq;->a(Lble;)Landroid/preference/Preference;
    ...
    :cond_10
    instance-of v7, v2, Lbkt;

    if-eqz v7, :cond_11

    check-cast v2, Lbkt;

    invoke-virtual {v4, v2}, Lbiq;->a(Lbkt;)Landroid/preference/Preference;
    ...
    iget-object v0, p0, Leqh;->b:Lbqm;

    invoke-virtual {v0}, Lbqm;->b()Landroid/hardware/SensorManager;

    move-result-object v0

    iget-object v2, p0, Leqh;->b:Lbqm;

    invoke-virtual {v2}, Lbqm;->a()Landroid/app/ActivityManager;
    ...
    iget-object v1, p0, Leqh;->f:Lgdo;

    invoke-virtual {v1}, Lgdo;->d()Z
    ...
    invoke-interface {v0}, Lbrm;->a()Ljhi;
