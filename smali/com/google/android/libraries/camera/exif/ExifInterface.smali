...
.method public constructor <init>()V
    ...
    invoke-direct {v0, v1}, Lidw;-><init>(Ljava/nio/ByteOrder;)V

    iput-object v0, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->P:Lidw;
...
.method public static a([Libv;Ljava/lang/String;)D
    .locals 8
...
.method private final b(II)Lieh;
    .locals 3

    const/4 v0, 0x0

    invoke-static {p2}, Lieh;->a(I)Z
    ...
    :cond_1
    iget-object v1, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->P:Lidw;

    int-to-short v2, p1

    iget-object v1, v1, Lidw;->a:[Liek;

    aget-object v1, v1, p2

    if-eqz v1, :cond_0

    invoke-virtual {v1, v2}, Liek;->a(S)Lieh;
...
.method private final c(II)[Libv;
    .locals 1

    invoke-direct {p0, p1, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->b(II)Lieh;
...
.method public final a(I)Libv;
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/android/libraries/camera/exif/ExifInterface;->c(II)[Libv;
    ...
    invoke-direct {v0, v1}, Libv;-><init>(Libv;)V

    goto :goto_0
.end method

.method public final a(ILjava/lang/Object;)Lieh;
    .locals 10
    ...
    invoke-virtual {v0, v1}, Lieh;->b(I)Z
    ...
    invoke-virtual {v0, p2}, Lieh;->a(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p2}, Lieh;->a([I)Z
    ...
    invoke-virtual {v0, p2}, Lieh;->a([J)Z
    ...
    :cond_9
    instance-of v1, p2, Libv;

    if-eqz v1, :cond_a

    check-cast p2, Libv;

    new-array v1, v6, [Libv;

    aput-object p2, v1, v7

    invoke-virtual {v0, v1}, Lieh;->a([Libv;)Z
    ...
    invoke-virtual {v0, p2}, Lieh;->a([Libv;)Z
    ...
    invoke-virtual {v0, p2}, Lieh;->a([B)Z
    ...
    invoke-virtual {v0, v1}, Lieh;->a([J)Z
    ...
    invoke-virtual {v0, v2}, Lieh;->a([B)Z
    ...
    :cond_11
    invoke-virtual {v0, v3}, Lieh;->a([I)Z
    ...
    :cond_1a
    invoke-virtual {v0, v3}, Lieh;->a([B)Z
...
.method public final a(Lieh;)Lieh;
    .locals 1

    iget-object v0, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->P:Lidw;

    invoke-virtual {v0, p1}, Lidw;->a(Lieh;)Lieh;
...
.method public final a(Ljava/io/OutputStream;)Ljava/io/OutputStream;
    ...
    iget-object v3, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->P:Lidw;

    invoke-direct {v1, v2, p0, v3}, Liei;-><init>(Ljava/io/OutputStream;Lcom/google/android/libraries/camera/exif/ExifInterface;Lidw;)V

    invoke-direct {v0, v1}, Lhzp;-><init>(Lhzq;)V
...
.method public final a(Ljava/io/InputStream;)V
    ...
    invoke-direct {v0, p0}, Lieg;-><init>(Lcom/google/android/libraries/camera/exif/ExifInterface;)V

    invoke-virtual {v0, p1}, Lieg;->a(Ljava/io/InputStream;)Lidw;
    :try_end_0
...
.method public final a(IJLjava/util/TimeZone;)Z
    ...
    invoke-virtual {p0, p1, v1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Lieh;
    ...
    :cond_2
    invoke-virtual {p0, v1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Lieh;)Lieh;
...
.method public final b(I)Ljava/lang/Integer;
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/android/libraries/camera/exif/ExifInterface;->b(II)Lieh;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v1, v0, Lieh;->f:Ljava/lang/Object;
    ...
    iget-object v0, v0, Lieh;->f:Ljava/lang/Object;
...
.method public getTagStringValue(I)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {v0}, Lieh;->c()Ljava/lang/String;
