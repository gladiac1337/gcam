...
.method public constructor <init>()V
    ...
    invoke-direct {v0, v1}, Lhku;-><init>(Ljava/nio/ByteOrder;)V

    iput-object v0, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->P:Lhku;
...
.method public static a([Lhiy;Ljava/lang/String;)D
    .locals 8
...
.method private final b(II)Lhlf;
    .locals 3
    ...
    .line 46
    :cond_1
    iget-object v1, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->P:Lhku;

    .line 47
    int-to-short v2, p1

    .line 49
    iget-object v1, v1, Lhku;->a:[Lhli;
    ...
    invoke-virtual {v1, v2}, Lhli;->a(S)Lhlf;
...
.method private final c(II)[Lhiy;
    .locals 1

    .prologue
    .line 88
    invoke-direct {p0, p1, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->b(II)Lhlf;
...
.method public final a(I)Lhiy;
    ...
    .line 83
    invoke-direct {p0, p1, v0}, Lcom/google/android/libraries/camera/exif/ExifInterface;->c(II)[Lhiy;
    ...
    invoke-direct {v0, v1}, Lhiy;-><init>(Lhiy;)V

    goto :goto_0
.end method

.method public final a(ILjava/lang/Object;)Lhlf;
    .locals 10
    ...
    invoke-virtual {v0, v1}, Lhlf;->b(I)Z
    ...
    invoke-virtual {v0, p2}, Lhlf;->a(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p2}, Lhlf;->a([I)Z
    ...
    invoke-virtual {v0, p2}, Lhlf;->a([J)Z
    ...
    .line 130
    new-array v1, v6, [Lhiy;

    aput-object p2, v1, v7

    invoke-virtual {v0, v1}, Lhlf;->a([Lhiy;)Z
    ...
    invoke-virtual {v0, p2}, Lhlf;->a([Lhiy;)Z
    ...
    invoke-virtual {v0, p2}, Lhlf;->a([B)Z
    ...
    invoke-virtual {v0, v1}, Lhlf;->a([J)Z
    ...
    invoke-virtual {v0, v2}, Lhlf;->a([B)Z
    ...
    .line 152
    :cond_11
    invoke-virtual {v0, v3}, Lhlf;->a([I)Z
    ...
    .line 173
    :cond_1a
    invoke-virtual {v0, v3}, Lhlf;->a([B)Z
...
.method public final a(Lhlf;)Lhlf;
    ...
    .prologue
    .line 194
    iget-object v0, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->P:Lhku;

    invoke-virtual {v0, p1}, Lhku;->a(Lhlf;)Lhlf;
...
.method public final a(Ljava/io/OutputStream;)Ljava/io/OutputStream;
    ...
    iget-object v3, p0, Lcom/google/android/libraries/camera/exif/ExifInterface;->P:Lhku;

    invoke-direct {v1, v2, p0, v3}, Lhlg;-><init>(Ljava/io/OutputStream;Lcom/google/android/libraries/camera/exif/ExifInterface;Lhku;)V

    invoke-direct {v0, v1}, Lhih;-><init>(Lhii;)V
...
.method public final a(Ljava/io/InputStream;)V
    ...
    invoke-direct {v0, p0}, Lhle;-><init>(Lcom/google/android/libraries/camera/exif/ExifInterface;)V

    invoke-virtual {v0, p1}, Lhle;->a(Ljava/io/InputStream;)Lhku;
    :try_end_0
    .catch Lhkx; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a(IJLjava/util/TimeZone;)Z
    ...
    invoke-virtual {p0, p1, v1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Lhlf;
    ...
    .line 209
    :cond_2
    invoke-virtual {p0, v1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Lhlf;)Lhlf;
...
.method public final b(I)Ljava/lang/Integer;
    ...
    .line 64
    invoke-direct {p0, p1, v0}, Lcom/google/android/libraries/camera/exif/ExifInterface;->b(II)Lhlf;
    ...
    .line 67
    iget-object v1, v0, Lhlf;->f:Ljava/lang/Object;
    ...
    .line 69
    iget-object v0, v0, Lhlf;->f:Ljava/lang/Object;
...
.method public getTagStringValue(I)Ljava/lang/String;
    ...
    .line 59
    :cond_0
    invoke-virtual {v0}, Lhlf;->c()Ljava/lang/String;
