...
# instance fields
.field public mBestInputBitmap:Liav;
...
.method private constructor <init>(IILjava/nio/ByteBuffer;Z)V
    ...
    iput-object v0, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liav;
...
.method private declared-synchronized closeInputBitmap()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liav;
...
# virtual methods
.method public declared-synchronized addPhoto(Liav;Ljava/util/List;J)V
    .locals 11
    ...
    iget-object v1, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liav;
    ...
    iput-object p1, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liav;

    iput-wide p3, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmapTimestampNs:J

    if-eqz v1, :cond_1

    invoke-interface {v1}, Liav;->close()V
    ...
    :try_start_2
    iget-object v2, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liav;
...
.method public declared-synchronized createAllSmiles(Lias;Z)Liav;
    .locals 4
    ...
    invoke-static {v2, v3}, Lid;->b(ZLjava/lang/Object;)V
    ...
    iput-object v1, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liav;
    :try_end_1
    ...
    invoke-static {p1, v1, v0, v2, v3}, Liat;->a(Lias;Ljava/lang/String;Ljava/nio/ByteBuffer;II)Liav;
    :try_end_3
...
.method public declared-synchronized createAnimation(Lias;ZI)Ljava/util/List;
    .locals 9
    ...
    invoke-direct {v1, v0}, Likk;-><init>(Liav;)V
    ...
    invoke-direct {v0, v1, v3}, Likk;-><init>(Likk;B)V
    ...
    invoke-static {p1, v1, v6, v7, v8}, Liat;->a(Lias;Ljava/lang/String;Ljava/nio/ByteBuffer;II)Liav;
