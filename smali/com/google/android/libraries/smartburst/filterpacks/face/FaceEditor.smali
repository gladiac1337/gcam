...
# instance fields
.field public mBestInputBitmap:Liwy;
...
.method private constructor <init>(IILjava/nio/ByteBuffer;Z)V
    ...
    iput-object v0, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liwy;
...
.method private declared-synchronized closeInputBitmap()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liwy;
...
# virtual methods
.method public declared-synchronized addPhoto(Liwy;Ljava/util/List;J)V
    .locals 11
    ...
    iget-object v1, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liwy;
    ...
    iput-object p1, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liwy;
    ...
    :try_start_2
    iget-object v2, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liwy;

    if-eq v2, p1, :cond_2

    invoke-interface {p1}, Liwy;->close()V
...
.method public declared-synchronized createAllSmiles(Liwv;Z)Liwy;
    .locals 4
    ...
    invoke-static {v2, v3}, Lixp;->b(ZLjava/lang/Object;)V
    ...
    iput-object v1, p0, Lcom/google/android/libraries/smartburst/filterpacks/face/FaceEditor;->mBestInputBitmap:Liwy;
    :try_end_1
    ...
    invoke-static {p1, v1, v0, v2, v3}, Liww;->a(Liwv;Ljava/lang/String;Ljava/nio/ByteBuffer;II)Liwy;
    :try_end_3
...
.method public declared-synchronized createAnimation(Liwv;ZI)Ljava/util/List;
    .locals 9
    ...
    invoke-direct {v1, v0}, Ljgn;-><init>(Liwy;)V
    ...
    invoke-direct {v0, v1, v3}, Ljgn;-><init>(Ljgn;B)V
    ...
    invoke-static {p1, v1, v6, v7, v8}, Liww;->a(Liwv;Ljava/lang/String;Ljava/nio/ByteBuffer;II)Liwy;
