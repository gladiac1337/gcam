...
.field public depthmapData:Lhhj;
...
.field public imageData$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFE9IMCRR3ELPIURB5EHGM8OBKC4NKEIBDC5JMAEO_0:Lhtm;
...
.method private finishParsingXMPMeta()V
    ...
    :goto_1
    invoke-static {v2}, Lhtm;->a(Lxb;)Lhtm;

    move-result-object v1

    iput-object v1, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFE9IMCRR3ELPIURB5EHGM8OBKC4NKEIBDC5JMAEO_0:Lhtm;

    iget-object v1, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFE9IMCRR3ELPIURB5EHGM8OBKC4NKEIBDC5JMAEO_0:Lhtm;

    if-eqz v1, :cond_2

    iget-object v1, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFE9IMCRR3ELPIURB5EHGM8OBKC4NKEIBDC5JMAEO_0:Lhtm;

    iget-object v3, v1, Lhtm;->b:[B
    ...
    :cond_2
    invoke-static {v2}, Lhhj;->a(Lxb;)Lhhj;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/refocus/image/RGBZ;->depthmapData:Lhhj;

    iget-object v0, p0, Lcom/google/android/apps/refocus/image/RGBZ;->depthmapData:Lhhj;

    if-eqz v0, :cond_3

    iget-object v0, p0, Lcom/google/android/apps/refocus/image/RGBZ;->depthmapData:Lhhj;

    iget-object v0, v0, Lhhj;->c:Lcom/google/android/apps/refocus/image/DepthTransform;
    ...
    :cond_3
    :goto_3
    invoke-static {v2}, Lhoy;->a(Lxb;)Lhoy;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v0, v0, Lhoy;->a:Lcom/google/android/apps/refocus/processing/FocusSettings;
    ...
    invoke-static {v3, v1}, Lbhy;->e(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_1

    :cond_4
    iget-object v0, v1, Lhtm;->b:[B

    iget-object v1, v1, Lhtm;->b:[B
    ...
    iget-object v4, v0, Lhhj;->a:Ljava/lang/String;
...
.method private writeXMPMeta(ILcom/google/android/libraries/camera/exif/ExifInterface;Ljava/io/OutputStream;)V
    ...
    invoke-static {v0}, Lhoy;->a(Lcom/google/android/apps/refocus/processing/FocusSettings;)Lhoy;
    ...
    iget-object v5, v0, Lhoy;->a:Lcom/google/android/apps/refocus/processing/FocusSettings;
    ...
    iget-object v0, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFE9IMCRR3ELPIURB5EHGM8OBKC4NKEIBDC5JMAEO_0:Lhtm;
    ...
    invoke-direct {v4}, Lhtm;-><init>()V

    const-string v5, "image/jpeg"

    iput-object v5, v4, Lhtm;->a:Ljava/lang/String;
    ...
    iput-object v0, v4, Lhtm;->b:[B

    iput-object v4, p0, Lcom/google/android/apps/refocus/image/RGBZ;->imageData$9HHMUR9FCTNMUPRCCKNM2RJ4E9NMIP1FC5O70SPFE9IMCRR3ELPIURB5EHGM8OBKC4NKEIBDC5JMAEO_0:Lhtm;
    ...
    invoke-static {p0}, Lhhj;->a(Lcom/google/android/apps/refocus/image/RGBZ;)Lhhj;
    ...
    iget-object v6, v0, Lhhj;->c:Lcom/google/android/apps/refocus/image/DepthTransform;
    ...
    iget-object v6, v0, Lhhj;->a:Ljava/lang/String;
    ...
    invoke-static {v2, v0}, Lfuw;->a(Lxb;Ljava/lang/String;)Z
    ...
    sget-object v4, Ljvg;->a:Ljvh;

    invoke-virtual {v4, v0}, Ljvh;->b(Ljava/lang/Throwable;)V
