...
.method public constructor <init>(Landroid/content/Context;Lbhm;)V
    ...
    .line 3
    iput-object p2, p0, Lcom/google/android/apps/refocus/processing/FaceDetector;->gservicesHelper:Lbhm;
...
.method private findLargestFace(Landroid/graphics/Bitmap;)Lcom/google/android/vision/face/Face;
    ...
    invoke-static {v3, v4, v0}, Lbhy;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_1
...
.method computeFaceFocus(Lcom/google/android/apps/refocus/image/RGBZ;Lcom/google/android/apps/refocus/processing/FocusSettings;)Z
    ...
    .line 5
    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/FaceDetector;->gservicesHelper:Lbhm;

    .line 6
    iget-object v3, v2, Lbhm;->a:Landroid/content/ContentResolver;

    const-string v4, "camera:refocus_face_enabled"

    invoke-virtual {v2, v3, v4, v1}, Lbhm;->a(Landroid/content/ContentResolver;Ljava/lang/String;Z)Z
