...
.method public render(Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;Lcom/google/android/apps/refocus/processing/ProgressCallback;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2}, Lhhn;->a(Landroid/content/Context;)Landroid/support/v8/renderscript/RenderScript;
    ...
    invoke-direct {v5, v2}, Lhho;-><init>(Landroid/support/v8/renderscript/RenderScript;)V
    ...
    sget-object v12, Lhhk;->a:Ljava/lang/String;

    const-string v13, "Negative depth of field"

    invoke-static {v12, v13}, Lbhy;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v2, v7, Lhhk;->b:[F

    invoke-static {v12}, Lhhk;->d(I)I
    ...
    invoke-virtual {v7, v2}, Lhhk;->a(I)F

    move-result v2

    const/16 v3, 0x40

    invoke-virtual {v7, v3}, Lhhk;->a(I)F
    ...
    invoke-direct {v2, v3}, Lhjt;-><init>(I)V
    ...
    invoke-virtual {v7, v4}, Lhhk;->a(I)F
    ...
    invoke-direct {v2, v4}, Lhjt;-><init>(I)V
    ...
    :cond_6
    invoke-virtual {v7, v12, v6}, Lhhk;->a(IF)Ljava/util/ArrayList;
    ...
    new-array v2, v6, [Lhjt;

    iput-object v2, v7, Lhhk;->c:[Lhjt;
    ...
    iget-object v15, v7, Lhhk;->c:[Lhjt;
    ...
    iget-object v2, v7, Lhhk;->c:[Lhjt;

    new-instance v15, Lhjt;

    invoke-direct {v15, v12, v13}, Lhjt;-><init>(II)V
    ...
    iput-object v2, v5, Lhho;->c:Landroid/graphics/Bitmap;

    new-instance v12, Lhhm;

    iget-object v2, v5, Lhho;->d:Landroid/support/v8/renderscript/RenderScript;

    const/4 v3, 0x0

    invoke-direct {v12, v2, v3}, Lhhm;-><init>(Landroid/support/v8/renderscript/RenderScript;B)V

    iget-object v3, v5, Lhho;->c:Landroid/graphics/Bitmap;

    iget-object v13, v5, Lhho;->b:Lhhk;

    iget v2, v13, Lhhk;->d:I

    iget-object v4, v13, Lhhk;->c:[Lhjt;

    aget-object v4, v4, v2

    new-instance v2, Lhhp;

    iget-object v5, v12, Lhhm;->b:Landroid/support/v8/renderscript/RenderScript;

    invoke-direct {v2, v5}, Lhhp;-><init>(Landroid/support/v8/renderscript/RenderScript;)V

    iput-object v2, v12, Lhhm;->c:Ljava/lang/Object;
    ...
    iget-object v7, v12, Lhhm;->b:Landroid/support/v8/renderscript/RenderScript;

    iget-object v2, v12, Lhhm;->c:Ljava/lang/Object;

    check-cast v2, Lhhp;

    invoke-direct {v6, v3, v5, v7, v2}, Lhtu;-><init>(Landroid/graphics/Bitmap;ILandroid/support/v8/renderscript/RenderScript;Lhhp;)V

    iput-object v6, v12, Lhhm;->d:Lhtu;

    iget-object v3, v12, Lhhm;->d:Lhtu;
    ...
    invoke-virtual {v2, v4, v15}, Lhhp;->invoke(ILandroid/support/v8/renderscript/FieldPacker;)V

    iget-object v4, v3, Lhtu;->c:Landroid/support/v8/renderscript/Allocation;
    ...
    iget-object v5, v2, Lhhp;->a:Landroid/support/v8/renderscript/Element;
    ...
    invoke-virtual/range {v2 .. v7}, Lhhp;->forEach(ILandroid/support/v8/renderscript/Allocation;Landroid/support/v8/renderscript/Allocation;Landroid/support/v8/renderscript/FieldPacker;Landroid/support/v8/renderscript/Script$LaunchOptions;)V

    move-object/from16 v0, p2

    invoke-virtual {v12, v13, v0}, Lhhm;->a(Lhhk;Lcom/google/android/apps/refocus/processing/ProgressCallback;)Z
    ...
    sget-object v4, Lhho;->a:Ljava/lang/String;
    ...
    sget-object v3, Lhhn;->a:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-virtual {v12, v13, v0}, Lhhm;->b(Lhhk;Lcom/google/android/apps/refocus/processing/ProgressCallback;)Z
    ...
    iget-object v5, v3, Lhtu;->d:Landroid/support/v8/renderscript/Allocation;
    ...
    iget-object v4, v2, Lhhp;->a:Landroid/support/v8/renderscript/Element;
    ...
    iget-object v2, v12, Lhhm;->d:Lhtu;

    iget-object v2, v2, Lhtu;->d:Landroid/support/v8/renderscript/Allocation;

    iget-object v3, v12, Lhhm;->d:Lhtu;

    iget-object v3, v3, Lhtu;->b:Landroid/graphics/Bitmap;

    invoke-virtual {v2, v3}, Landroid/support/v8/renderscript/Allocation;->copyTo(Landroid/graphics/Bitmap;)V

    iget-object v2, v12, Lhhm;->d:Lhtu;

    iget-object v2, v2, Lhtu;->b:Landroid/graphics/Bitmap;

    iget-object v3, v12, Lhhm;->b:Landroid/support/v8/renderscript/RenderScript;

    invoke-virtual {v3}, Landroid/support/v8/renderscript/RenderScript;->finish()V

    sget-object v3, Lhhm;->a:Ljava/lang/String;
