...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, v0}, Lbjg;-><init>(Lbjf;)V

    iput-object v1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Lbjg;
    ...
    invoke-direct {v0, v2}, Lbjh;-><init>(Landroid/graphics/drawable/ShapeDrawable;)V

    iput-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Lbjh;
...
.method constructor <init>(Landroid/content/Context;Lbjg;Lbjh;)V
    .locals 1

    invoke-direct {p0, p1}, Landroid/view/View;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Lbjg;

    iput-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Lbjh;
...
.method private static a(Lgls;)I
    .locals 1

    invoke-virtual {p0}, Lgls;->ordinal()I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Lbjg;

    iget-object v1, v0, Lbjg;->a:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-static {p1, v1, v0}, Lbjf;->a(Landroid/graphics/Canvas;Landroid/graphics/drawable/Drawable;F)V

    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Lbjh;

    iget-object v1, v0, Lbjh;->a:Landroid/graphics/drawable/ShapeDrawable;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->d:Lgls;
    ...
    invoke-static {v2, v3, v4, v5}, Lgls;->a(Landroid/view/Display;Landroid/content/Context;II)Lgls;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->d:Lgls;

    iget-boolean v2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->f:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->d:Lgls;
    ...
    invoke-static {v2}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a(Lgls;)I

    move-result v0

    invoke-static {v1}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a(Lgls;)I
    ...
    invoke-virtual {v0}, Lhix;->ordinal()I
...
.method protected onSizeChanged(IIII)V
    ...
    iget-object v0, v0, Lbjg;->a:Landroid/graphics/drawable/GradientDrawable;

    invoke-virtual {v0, v1, v1, p1, p2}, Landroid/graphics/drawable/GradientDrawable;->setBounds(IIII)V

    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Lbjh;

    iget-object v0, v0, Lbjh;->a:Landroid/graphics/drawable/ShapeDrawable;
