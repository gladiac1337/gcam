...
.method public static createXMPMeta()Lud;
    .locals 1
...
.method public static extractOrCreateXMPMeta(Ljava/lang/String;)Lud;
    .locals 1

    invoke-static {p0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Ljava/lang/String;)Lud;
...
.method public static extractXMPMeta(Ljava/io/InputStream;)Lud;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Ljava/io/InputStream;Z)Lud;
...
.method public static extractXMPMeta(Ljava/io/InputStream;Z)Lud;
    .locals 6
    ...
    :cond_0
    invoke-static {v3}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->parseFirstValidXMPSection(Ljava/util/List;)Lud;
    ...
    invoke-interface {v2, v0, v4}, Lud;->c(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {v2, v0, v4}, Lud;->a(Ljava/lang/String;Ljava/lang/String;)Lvk;

    move-result-object v0

    invoke-interface {v0}, Lvk;->a()Ljava/lang/Object;
    ...
    :cond_4
    invoke-static {v3, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->parseExtendedXMPSections(Ljava/util/List;Ljava/lang/String;)Lud;
    ...
    :cond_5
    :try_start_1
    invoke-interface {v0}, Lud;->a()Luc;

    move-result-object v1

    :cond_6
    :goto_1
    invoke-virtual {v1}, Luc;->next()Ljava/lang/Object;
    ...
    iget-object v3, v0, Lvl;->b:Ljava/lang/String;

    if-eqz v3, :cond_6

    iget-object v3, v0, Lvl;->a:Ljava/lang/String;

    iget-object v4, v0, Lvl;->b:Ljava/lang/String;

    iget-object v5, v0, Lvl;->c:Ljava/lang/Object;

    iget-object v0, v0, Lvl;->d:Luv;

    invoke-virtual {v0}, Luv;->h()Lvh;

    move-result-object v0

    invoke-interface {v2, v3, v4, v5, v0}, Lud;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Lvh;)V
    :try_end_1
...
.method public static extractXMPMeta(Ljava/lang/String;)Lud;
    .locals 9
    ...
    invoke-static {v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Ljava/io/InputStream;)Lud;
    :try_end_0
...
.method private static parseExtendedXMPSections(Ljava/util/List;Ljava/lang/String;)Lud;
    .locals 12
...
.method private static parseFirstValidXMPSection(Ljava/util/List;)Lud;
    .locals 7
...
.method private static serializeMeta(Lud;)[B
    .locals 6
    ...
    invoke-virtual {v0}, Lvi;->b()Lvi;

    invoke-virtual {v0}, Lvi;->a()Lvi;

    invoke-static {p0, v0}, Lue;->a(Lud;Lvi;)[B
    :try_end_0
    .catch Lub; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static writeXMPMeta(Ljava/io/InputStream;Ljava/io/OutputStream;Lud;Lud;)Z
    .locals 7
    ...
    invoke-static {p3}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->serializeMeta(Lud;)[B
    ...
    invoke-interface {v1, v4, v5, v3}, Lud;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Lub; {:try_start_0 .. :try_end_0} :catch_0

    :cond_3
    invoke-static {v1}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->serializeMeta(Lud;)[B
    ...
    invoke-interface {v1, v4, v5}, Lud;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static writeXMPMeta(Ljava/lang/String;Lud;)Z
    .locals 10
    ...
    :try_start_4
    invoke-static {v7, v1, p1, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->writeXMPMeta(Ljava/io/InputStream;Ljava/io/OutputStream;Lud;Lud;)Z
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
