...
.field public clickEnabledObservable:Lhzv;
...
.field public final filteredClickEnabledObservable:Liaj;

.field public gestureDetector:Lgub;
...
.field public onDrawListener:Lgts;
...
.field public touchCoordinate:Lgyw;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->clickEnabledObservable:Lhzv;

    iget-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->clickEnabledObservable:Lhzv;

    invoke-static {v0}, Liak;->b(Liaj;)Liaj;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->filteredClickEnabledObservable:Liaj;

    sget-object v0, Lgtt;->a:Lgtt;

    iput-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->currentMode:Lgtt;
    ...
    invoke-direct {v0, p0}, Lgtk;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method public static synthetic access$300(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)Lgtz;
    .locals 1

    iget-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->listener:Lgtz;
...
.method public static synthetic access$3500(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)Lgtt;
    .locals 1

    iget-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->currentMode:Lgtt;
...
.method private animateMainButton(Lgtt;)V
    .locals 6

    const/4 v5, 0x1

    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->getInnerPhotoButtonAnimator(Lgtt;)Landroid/animation/AnimatorSet;

    move-result-object v0

    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->getInnerVideoButtonAnimator(Lgtt;)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v0, p0}, Lgsn;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method private animateVideoConfirmColor(Z)V
    ...
    invoke-direct {v1, p0}, Lgtf;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    new-instance v1, Lgtg;

    invoke-direct {v1, p0}, Lgtg;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method private fadeStopSquare(ZZ)V
    ...
    invoke-direct {v1, p0}, Lgsq;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method private getBreathingAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v1, p0}, Lgsr;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method private getInnerPhotoButtonAnimator(Lgtt;)Landroid/animation/AnimatorSet;
    .locals 7
    ...
    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->isVideoMode(Lgtt;)Z
    ...
    invoke-direct {v4, p0, v2}, Lgsy;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;I)V
    ...
    invoke-direct {v2, p0, v3}, Lgtj;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;Z)V
...
.method private getInnerVideoButtonAnimator(Lgtt;)Landroid/animation/ValueAnimator;
    .locals 4
    ...
    invoke-direct {v1, p0}, Lgtl;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method private getRippleAnimator()Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v2, p0, v1}, Lgto;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;I)V

    invoke-virtual {v0, v2}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    new-instance v1, Lgtp;

    invoke-direct {v1, p0}, Lgtp;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method private initialize()V
    ...
    invoke-direct {v1, p0}, Lgtr;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V

    invoke-direct {v0, v1}, Lgub;-><init>(Landroid/view/GestureDetector$SimpleOnGestureListener;)V

    iput-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->gestureDetector:Lgub;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->resetShutterButton(Lgtt;)V
    ...
    invoke-direct {v0, p0}, Lgtu;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
    ...
    invoke-direct {p0, v0}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->updateContentDescription(Lgtt;)V

    return-void
.end method

.method private isVideoMode(Lgtt;)Z
    .locals 1

    sget-object v0, Lgtt;->b:Lgtt;

    if-eq p1, v0, :cond_0

    sget-object v0, Lgtt;->e:Lgtt;
...
.method private runButtonImageAnimator(ZZ)V
    ...
    invoke-direct {v2, p0, p2, v1}, Lgtb;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;ZI)V
...
.method private runEnableChangeAnimation(Z)V
    ...
    invoke-direct {v1, p0}, Lgsw;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method private runImageButtonAnimation(Lgtt;IZZ)V
    .locals 9
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->currentMode:Lgtt;

    iget-object v1, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->currentMode:Lgtt;

    invoke-direct {p0, v1}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->updateContentDescription(Lgtt;)V
    ...
    invoke-direct/range {v0 .. v5}, Lgsz;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;ZIII)V

    invoke-virtual {v8, v0}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    new-instance v0, Lgta;

    invoke-direct {v0, p0, p4}, Lgta;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;Z)V
...
.method private runPressedStateAnimation(Z)V
    ...
    invoke-virtual {p0}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->getClickEnabledObservable()Liaj;
    ...
    invoke-direct {v1, p0, p1}, Lgtn;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;Z)V
...
.method private runVideoClickAnimation(ZZ)V
    ...
    invoke-direct {v3, p0}, Lgtq;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
    ...
    invoke-direct {v3, p0, v1}, Lgsp;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;I)V
    ...
    invoke-direct {v3, p0}, Lgso;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method private transitionToConfirm(IZ)Z
    ...
    sget-object v0, Lgtt;->d:Lgtt;

    invoke-direct {p0, v0, p1, v1, p2}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->runImageButtonAnimation(Lgtt;IZZ)V
...
.method private updateContentDescription(Lgtt;)V
    .locals 2
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->gestureDetector:Lgub;

    iget-object v3, v0, Lgub;->a:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, v0, Lgub;->f:Landroid/view/MotionEvent;

    if-eqz v4, :cond_3

    iget-object v4, v0, Lgub;->d:Landroid/os/Handler;

    iget-object v5, v0, Lgub;->g:Ljava/lang/Runnable;
    ...
    iput-object v4, v0, Lgub;->f:Landroid/view/MotionEvent;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lgyw;-><init>(FFFF)V

    iput-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->touchCoordinate:Lgyw;
...
.method public getClickEnabledObservable()Liaj;
    .locals 1

    iget-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->filteredClickEnabledObservable:Liaj;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->onDrawListener:Lgts;

    if-eqz v0, :cond_3

    iget-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->onDrawListener:Lgts;

    iget-object v0, v0, Lgts;->a:Lbtz;

    iget-object v0, v0, Lbtz;->i:Lcom/google/android/apps/camera/legacy/app/stats/CameraActivitySession;
    ...
    invoke-direct {p0, v0}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->isVideoMode(Lgtt;)Z
...
.method public performClick()Z
    ...
    iget-object v1, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->listener:Lgtz;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->touchCoordinate:Lgyw;

    if-eqz v1, :cond_2

    iget-object v1, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->listener:Lgtz;

    iget-object v2, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->touchCoordinate:Lgyw;

    invoke-interface {v1, v2}, Lgtz;->a(Lgyw;)V

    :cond_2
    const/4 v1, 0x0

    iput-object v1, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->touchCoordinate:Lgyw;

    iget-object v1, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->listener:Lgtz;

    invoke-interface {v1}, Lgtz;->a()V
...
.method public removeListener()V
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->listener:Lgtz;

    return-void
.end method

.method public resetShutterButton(Lgtt;)V
    .locals 4
...
.method public setEnabled(Z)V
    ...
    invoke-direct {v0, p0, p1}, Lgtd;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;Z)V
...
.method public setListener(Lgtz;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->listener:Lgtz;

    return-void
.end method

.method public setMode(Lgtt;)V
    .locals 1
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->animateMainButton(Lgtt;)V

    iput-object p1, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->currentMode:Lgtt;

    invoke-virtual {p1}, Lgtt;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->setTag(Ljava/lang/Object;)V

    invoke-direct {p0, p1}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->updateContentDescription(Lgtt;)V

    goto :goto_0
.end method

.method public setOnDrawListener(Lgts;)V
    .locals 2
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->onDrawListener:Lgts;
...
.method public startLongPressRipple()V
    ...
    invoke-direct {v1, p0}, Lgss;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
    ...
    invoke-direct {v2, p0}, Lgst;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method public stopLongPressRipple()V
    ...
    invoke-direct {v2, p0, v0}, Lgsu;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;I)V
    ...
    invoke-direct {v1, p0}, Lgsv;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method public transitionToCancel()Z
    ...
    invoke-direct {p0, v0, v1, v2, v2}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->runImageButtonAnimation(Lgtt;IZZ)V
...
.method public transitionToCapture()Z
    ...
    iget-object v2, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->currentMode:Lgtt;

    sget-object v3, Lgtt;->c:Lgtt;
    ...
    invoke-direct {p0, v1, v2, v0, v0}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->runImageButtonAnimation(Lgtt;IZZ)V
    ...
    invoke-direct {p0, v2, v3, v1, v0}, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->runImageButtonAnimation(Lgtt;IZZ)V
...
.method public transitionToPanoramaConfirm()V
    ...
    invoke-direct {v3, p0, v0, v1}, Lgte;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;Landroid/animation/ArgbEvaluator;I)V
...
.method public transitionToVideoIntentCapture()Z
    ...
    iput-object v1, p0, Lcom/google/android/apps/camera/shutterbutton/ShutterButton;->currentMode:Lgtt;
    ...
    invoke-direct {v2, p0}, Lgti;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
...
.method public transitionToVideoIntentConfirm()Z
    ...
    invoke-direct {v1, p0}, Lgth;-><init>(Lcom/google/android/apps/camera/shutterbutton/ShutterButton;)V
