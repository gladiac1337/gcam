...
.method public constructor <init>(Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lejd;->a:Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;
...
.method public final run()V
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lejd;->a:Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;

    iget-object v0, v0, Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;->k:Lgow;

    invoke-virtual {v0}, Lgow;->a()Lgov;
    ...
    .line 3
    iget-object v1, p0, Lejd;->a:Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;
    ...
    .line 6
    :try_start_1
    iget-object v2, p0, Lejd;->a:Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;

    .line 7
    iput-object v0, v2, Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;->d:Lgov;
    ...
    .line 12
    iget-object v2, v2, Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;->d:Lgov;

    .line 13
    invoke-interface {v2}, Lgov;->suspend()V
    ...
    iget-object v1, v1, Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;->o:Lhzt;

    new-instance v2, Leje;

    invoke-direct {v2, v0}, Leje;-><init>(Ljava/lang/Exception;)V
    ...
    .line 24
    invoke-interface {v0}, Lgov;->getSession()Lgou;
    ...
    .line 26
    invoke-interface {v2, v1}, Lgou;->a(Lgox;)V
    ...
    .line 29
    invoke-interface {v0, v1}, Lgov;->process(Landroid/content/Context;)V
    ...
    iput-object v2, v0, Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;->d:Lgov;
