...
.method public constructor <init>(Lbxg;)V
    ...
    iput-object v0, p0, Lbwy;->i:Ljava/util/Map;

    .line 5
    sget-object v0, Lbwy;->l:Lbxh;

    iput-object v0, p0, Lbwy;->j:Lbxh;

    .line 6
    iput-object p1, p0, Lbwy;->k:Lbxg;
...
# virtual methods
.method final a(Lbzv;II)Landroid/view/View;
    .locals 4

    .prologue
    .line 78
    iget-object v0, p0, Lbwy;->e:Landroid/widget/LinearLayout;
    ...
    iget-object v2, p0, Lbwy;->e:Landroid/widget/LinearLayout;
    ...
    .line 81
    iget-object v1, p0, Lbwy;->e:Landroid/widget/LinearLayout;
    ...
    .line 88
    iget-object v1, p0, Lbwy;->i:Ljava/util/Map;
    ...
    invoke-direct {v1, p0, p1}, Lbxe;-><init>(Lbwy;Lbzv;)V
...
.method public final a()V
    ...
    .line 9
    iget-object v0, p0, Lbwy;->b:Landroid/support/design/widget/FloatingActionButton;

    invoke-virtual {v0, v1}, Landroid/support/design/widget/FloatingActionButton;->setVisibility(I)V

    .line 10
    iget-object v0, p0, Lbwy;->c:Landroid/view/View;
...
.method final a(Z)V
    ...
    iget-object v1, p0, Lbwy;->b:Landroid/support/design/widget/FloatingActionButton;
    ...
    .line 34
    :goto_0
    iget-object v1, p0, Lbwy;->c:Landroid/view/View;
    ...
    invoke-direct {v2, p0}, Lbxd;-><init>(Lbwy;)V
    ...
    .line 72
    :cond_c
    iget-object v0, p0, Lbwy;->g:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v0, p0}, Lbxc;-><init>(Lbwy;)V
...
.method final b()V
    ...
    invoke-virtual {p0, v0}, Lbwy;->a(Z)V
...
.method public final c()V
    ...
    .prologue
    .line 91
    iget-object v0, p0, Lbwy;->k:Lbxg;

    .line 93
    iget-object v1, v0, Lbxg;->a:Lbxi;
    ...
    .line 98
    :cond_0
    iget-object v0, v0, Lbxg;->a:Lbxi;

    .line 99
    iget-object v0, v0, Lbxi;->f:Lcag;

    .line 100
    invoke-interface {v0}, Lcag;->b()Liwe;
