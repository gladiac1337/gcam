...
# direct methods
.method constructor <init>(Lhka;Lcom/google/android/gms/feedback/FeedbackOptions;Landroid/os/Bundle;JLcom/google/android/gms/googlehelp/GoogleHelp;)V
    .locals 2

    iput-object p2, p0, Lhoc;->a:Lcom/google/android/gms/feedback/FeedbackOptions;

    iput-object p3, p0, Lhoc;->b:Landroid/os/Bundle;

    iput-wide p4, p0, Lhoc;->c:J

    iput-object p6, p0, Lhoc;->d:Lcom/google/android/gms/googlehelp/GoogleHelp;

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lhoe;-><init>(Lhka;B)V
...
.method protected final a(Lhog;)V
    ...
    :try_start_0
    iget-object v0, p0, Lhoc;->a:Lcom/google/android/gms/feedback/FeedbackOptions;

    iget-object v1, p0, Lhoc;->b:Landroid/os/Bundle;

    iget-wide v2, p0, Lhoc;->c:J

    iget-object v4, p0, Lhoc;->d:Lcom/google/android/gms/googlehelp/GoogleHelp;

    new-instance v5, Lhod;

    invoke-direct {v5, p0}, Lhod;-><init>(Lhoc;)V
    ...
    :goto_2
    invoke-interface {v5}, Lhnt;->asBinder()Landroid/os/IBinder;
    ...
    invoke-virtual {p0, v0}, Lhoc;->c(Lcom/google/android/gms/common/api/Status;)V
