...
.method public constructor <init>(Ljava/lang/String;IJLjava/io/File;JJ)V
    ...
    .line 3
    iput-object p5, p0, Lirn;->d:Ljava/io/File;

    .line 4
    iput-wide p6, p0, Lirn;->e:J

    .line 5
    iput-wide p8, p0, Lirn;->f:J
...
.method public final a(Lixy;Ljeg;Ljava/util/concurrent/Executor;Lixg;)Lilf;
    ...
    iget-object v4, v0, Lipm;->a:Ljava/lang/String;
    ...
    iget-wide v10, v0, Lirn;->f:J

    move-object/from16 v0, p0

    iget-wide v12, v0, Lirn;->e:J
    ...
    .line 20
    invoke-direct/range {v3 .. v11}, Ljdp;-><init>(Ljava/lang/String;Ljava/lang/String;JIIJ)V
    ...
    invoke-interface {v0, v3}, Ljeg;->a(Ljef;)Ljava/io/OutputStream;
    ...
    iget-object v2, v0, Lirn;->d:Ljava/io/File;
    :try_end_0
    ...
    invoke-direct {v4, v2, v7, v3}, Liro;-><init>(Ljava/io/InputStream;Ljava/io/OutputStream;Ljdp;)V

    move-object/from16 v0, p3

    invoke-static {v0, v4}, Licy;->a(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Lilf;
    :try_end_4
    ...
    :try_start_a
    invoke-static {v5, v2}, Ljvs;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
