...
.field private d:Lidb;

.field private e:Ljava/util/concurrent/Executor;


# direct methods
.method public constructor <init>(Landroid/hardware/camera2/CameraManager;Lidb;Ljava/util/concurrent/Executor;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lchc;->c:Landroid/hardware/camera2/CameraManager;

    iput-object p2, p0, Lchc;->d:Lidb;

    iput-object p3, p0, Lchc;->e:Ljava/util/concurrent/Executor;
...
.method private final c()Ljuk;
    ...
    iget-object v0, p0, Lchc;->e:Ljava/util/concurrent/Executor;
...
.method public final a()Ljuk;
    ...
    :try_start_0
    iget-object v0, p0, Lchc;->c:Landroid/hardware/camera2/CameraManager;
...
.method final b()Z
    ...
    invoke-direct {v2, v4}, Lche;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;)V
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_3

    :try_start_2
    iget-object v1, p0, Lchc;->c:Landroid/hardware/camera2/CameraManager;

    const-string v6, "PollUntilReconnect"

    invoke-static {v5, v6}, Lhzd;->a(Lhzg;Ljava/lang/String;)Landroid/os/Handler;
    ...
    iget-object v6, p0, Lchc;->c:Landroid/hardware/camera2/CameraManager;
    ...
    iget-object v1, p0, Lchc;->d:Lidb;

    sget-object v4, Lidc;->a:Lidc;

    invoke-interface {v1, v4}, Lidb;->a(Lidc;)V
    :try_end_2
    .catch Ljava/lang/Throwable; {:try_start_2 .. :try_end_2} :catch_6
    .catchall {:try_start_2 .. :try_end_2} :catchall_4

    :try_start_3
    invoke-virtual {v5}, Lhzg;->close()V
    :try_end_3
    ...
    invoke-interface {v1, v3}, Lidb;->a(Lidc;)V
    :try_end_9
