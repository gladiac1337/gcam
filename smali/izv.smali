...
.method public constructor <init>()V
    ...
    invoke-static {v0}, Lizv;->a(I)Ljava/nio/FloatBuffer;

    move-result-object v0

    iput-object v0, p0, Lizv;->f:Ljava/nio/FloatBuffer;
    ...
    iput-object v0, p0, Lizv;->g:Ljava/nio/FloatBuffer;
...
.method public final declared-synchronized a(Landroid/graphics/Bitmap;)Ljava/util/List;
    ...
    .line 13
    :try_start_1
    invoke-static {p1}, Liui;->a(Landroid/graphics/Bitmap;)Lcom/google/android/libraries/smartburst/filterfw/FrameImage2D;
    ...
    invoke-static {v0, v2}, Liui;->a(II)Lcom/google/android/libraries/smartburst/filterfw/FrameImage2D;
    ...
    .line 17
    iget-object v1, p0, Lizv;->f:Ljava/nio/FloatBuffer;

    invoke-virtual {v1}, Ljava/nio/FloatBuffer;->rewind()Ljava/nio/Buffer;

    .line 18
    iget-object v1, p0, Lizv;->g:Ljava/nio/FloatBuffer;
    ...
    iget-object v6, p0, Lizv;->f:Ljava/nio/FloatBuffer;

    iget-object v7, p0, Lizv;->g:Ljava/nio/FloatBuffer;
    ...
    invoke-static {v1}, Lizv;->a(Ljava/nio/FloatBuffer;)[F

    move-result-object v1

    .line 21
    iget-object v2, p0, Lizv;->g:Ljava/nio/FloatBuffer;

    invoke-static {v2}, Lizv;->a(Ljava/nio/FloatBuffer;)[F
    ...
    invoke-direct {v3, v4, v1}, Lcom/google/android/libraries/smartburst/utils/Feature;-><init>(Ljfs;[F)V

    .line 23
    new-instance v1, Lcom/google/android/libraries/smartburst/utils/Feature;

    sget-object v4, Ljfs;->g:Ljfs;

    invoke-direct {v1, v4, v2}, Lcom/google/android/libraries/smartburst/utils/Feature;-><init>(Ljfs;[F)V
