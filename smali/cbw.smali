...
.method public final destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Lcbw;->a:Lcbm;

    iget-object v1, v0, Lcbm;->k:Ljava/util/Map;
...
.method public final instantiateItem(Landroid/view/ViewGroup;I)Ljava/lang/Object;
    ...
    iget-object v0, v0, Lcbm;->h:Landroid/content/Context;

    invoke-direct {v1, v0}, Ljwj;-><init>(Landroid/content/Context;)V

    new-instance v0, Landroid/widget/LinearLayout$LayoutParams;

    invoke-direct {v0, v2, v2}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V

    invoke-virtual {v1, v0}, Ljwj;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    sget-object v0, Landroid/widget/ImageView$ScaleType;->FIT_CENTER:Landroid/widget/ImageView$ScaleType;

    invoke-virtual {v1, v0}, Ljwj;->setScaleType(Landroid/widget/ImageView$ScaleType;)V

    invoke-virtual {v1}, Ljwj;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {v1, v0}, Ljwj;->setContentDescription(Ljava/lang/CharSequence;)V

    new-instance v0, Lcbx;

    invoke-direct {v0, p0}, Lcbx;-><init>(Lcbw;)V

    invoke-virtual {v1, v0}, Ljwj;->setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    iget-object v6, v2, Lfvf;->f:Ljava/util/Date;
    ...
    iget-object v3, p0, Lcbw;->a:Lcbm;

    iget-object v3, v3, Lcbm;->a:Lcbv;

    iget-object v4, v2, Lfvf;->h:Landroid/net/Uri;

    invoke-virtual {v3, v4}, Lcbv;->a(Landroid/net/Uri;)Ladg;
    ...
    iget-object v0, v2, Lfvf;->h:Landroid/net/Uri;
