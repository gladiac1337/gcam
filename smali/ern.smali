...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v0}, Lern;->setScaleType(Landroid/widget/ImageView$ScaleType;)V

    .line 5
    new-instance v0, Lero;

    invoke-direct {v0, p0}, Lero;-><init>(Lern;)V

    invoke-virtual {p0, v0}, Lern;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V
...
.method public final a()V
    ...
    .prologue
    .line 7
    iget-object v0, p0, Lern;->d:Lerp;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lern;->d:Lerp;

    invoke-virtual {v0}, Lerp;->isCancelled()Z
    ...
    invoke-virtual {v0, v1}, Lerp;->cancel(Z)Z

    .line 9
    const/16 v0, 0x8

    invoke-virtual {p0, v0}, Lern;->setVisibility(I)V
...
.method final b()Ljava/io/InputStream;
    ...
    .line 29
    :try_start_0
    invoke-virtual {p0}, Lern;->getContext()Landroid/content/Context;
    ...
    iget-object v2, p0, Lern;->e:Landroid/net/Uri;
