...
# direct methods
.method constructor <init>(Lbhb;Ljava/lang/String;)V
    .locals 0
...
.method public final run()V
    ...
    .line 10
    :cond_1
    iget-object v3, v2, Lbhb;->b:Landroid/media/MediaCodec;
    ...
    .line 14
    iget-object v0, v2, Lbhb;->c:Lbgm;

    invoke-virtual {v0}, Lbgm;->c()Z
    ...
    .line 16
    :cond_2
    iget-object v0, v2, Lbhb;->b:Landroid/media/MediaCodec;
    ...
    .line 19
    :cond_3
    iget-object v3, v2, Lbhb;->c:Lbgm;

    .line 20
    iget-object v4, v3, Lbgm;->b:Ljava/lang/Object;

    monitor-enter v4

    .line 21
    :try_start_0
    iget-object v5, v3, Lbgm;->d:Lbha;
    ...
    .line 23
    :cond_4
    iget-object v5, v3, Lbgm;->f:Lbgn;

    .line 24
    iget-boolean v5, v5, Lbgn;->a:Z
    ...
    iget-object v6, v3, Lbgm;->a:Landroid/media/MediaMuxer;

    invoke-virtual {v6, v0}, Landroid/media/MediaMuxer;->addTrack(Landroid/media/MediaFormat;)I

    move-result v0

    invoke-virtual {v5, v0}, Lbgn;->a(I)V

    .line 28
    const-string v0, "MediaMuxerProc"

    iget-object v3, v3, Lbgm;->f:Lbgn;

    invoke-virtual {v3}, Lbgn;->a()I
    ...
    .line 33
    :cond_8
    iget-object v4, v2, Lbhb;->b:Landroid/media/MediaCodec;
    ...
    .line 41
    iget-object v5, v2, Lbhb;->c:Lbgm;

    invoke-virtual {v5}, Lbgm;->c()Z
    ...
    invoke-virtual {v5, v6, v7}, Lbgm;->a(J)V
    ...
    invoke-virtual {v5, v4, v0}, Lbgm;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    .line 46
    sget-boolean v4, Lbhb;->a:Z
