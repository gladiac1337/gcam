...
.method public constructor <init>(Ljava/util/EnumSet;IF)V
    ...
    iput-object v0, p0, Lhvd;->h:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object v0, p0, Lhvd;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-wide v0, p0, Lhvd;->g:J

    .line 7
    iput p3, p0, Lhvd;->k:F

    .line 8
    invoke-static {p1}, Lhvd;->a(Ljava/util/EnumSet;)I
    ...
    iput-object v0, p0, Lhvd;->b:[I

    .line 10
    iget-object v0, p0, Lhvd;->b:[I
    ...
    .line 22
    iput-object p1, p0, Lhvd;->a:Ljava/util/EnumSet;
    ...
    iput-object v1, p0, Lhvd;->c:Ljava/util/concurrent/atomic/AtomicIntegerArray;
    ...
    iput-object v0, p0, Lhvd;->d:Ljava/util/concurrent/atomic/AtomicIntegerArray;
    ...
    .line 27
    iget-object v0, p0, Lhvd;->d:Ljava/util/concurrent/atomic/AtomicIntegerArray;
    ...
    iput-object v0, p0, Lhvd;->j:Ljava/util/concurrent/atomic/AtomicIntegerArray;
...
.method private final a(J)I
    ...
    .line 132
    iget-object v0, p0, Lhvd;->h:Ljava/util/concurrent/atomic/AtomicLong;
...
.method private final a(Lije;I)I
    .locals 3
...
.method private final a(IIIFLijk;)V
    .locals 6
    ...
    .line 120
    iget-object v3, p0, Lhvd;->c:Ljava/util/concurrent/atomic/AtomicIntegerArray;
    ...
    .line 125
    iget-object v4, p0, Lhvd;->c:Ljava/util/concurrent/atomic/AtomicIntegerArray;
    ...
    invoke-virtual {p5, v0, p4, v4}, Lijk;->a(FFF)F
    ...
    .line 129
    iget-object v5, p0, Lhvd;->c:Ljava/util/concurrent/atomic/AtomicIntegerArray;
...
.method private final a(Lije;)V
    .locals 4

    .prologue
    .line 138
    iget-object v0, p0, Lhvd;->a:Ljava/util/EnumSet;
...
.method final a(Lije;II)Lcom/google/android/libraries/smartburst/utils/Feature;
    .locals 5
    ...
    .line 154
    invoke-direct {p0, p1}, Lhvd;->a(Lije;)V
    ...
    invoke-direct {v0, p1}, Lcom/google/android/libraries/smartburst/utils/Feature;-><init>(Lije;)V
    ...
    .line 161
    invoke-direct {p0, p1, v1}, Lhvd;->a(Lije;I)I
    ...
    invoke-direct {v0, p1, v2}, Lcom/google/android/libraries/smartburst/utils/Feature;-><init>(Lije;[F)V

    goto :goto_1
.end method

.method public final getAssignmentCount(Lije;)I
    .locals 2
    ...
    iget-object v0, p0, Lhvd;->j:Ljava/util/concurrent/atomic/AtomicIntegerArray;
...
.method public final getColumnValues(Lije;)[Lcom/google/android/libraries/smartburst/utils/Feature;
    .locals 4
    ...
    .line 99
    invoke-virtual {p0, p1, v1, v2}, Lhvd;->a(Lije;II)Lcom/google/android/libraries/smartburst/utils/Feature;
...
.method public final getFeature(JLije;)Lcom/google/android/libraries/smartburst/utils/Feature;
    .locals 1

    .prologue
    .line 90
    invoke-virtual {p0, p1, p2}, Lhvd;->getRowForTimestamp(J)Lhve;

    move-result-object v0

    invoke-virtual {v0, p3}, Lhve;->a(Lije;)Lcom/google/android/libraries/smartburst/utils/Feature;
...
.method public final getLatestValidTimestamp()J
    ...
    .line 78
    iget-object v2, p0, Lhvd;->a:Ljava/util/EnumSet;
    ...
    .line 79
    iget-object v1, p0, Lhvd;->d:Ljava/util/concurrent/atomic/AtomicIntegerArray;
    ...
    .line 83
    invoke-virtual {p0, v1}, Lhvd;->a(I)J

    move-result-wide v6

    .line 84
    iget-wide v0, v0, Lije;->D:J
...
.method public final getNumRowsWithData()I
    ...
    .line 72
    :goto_0
    iget-object v4, p0, Lhvd;->d:Ljava/util/concurrent/atomic/AtomicIntegerArray;
    ...
    .line 74
    iget-object v2, p0, Lhvd;->d:Ljava/util/concurrent/atomic/AtomicIntegerArray;
...
.method public final getRowForTimestamp(J)Lhve;
    .locals 1

    .prologue
    .line 102
    invoke-virtual {p0, p1, p2}, Lhvd;->getRowIterator(J)Lhvf;

    move-result-object v0

    invoke-virtual {v0}, Lhvf;->next()Ljava/lang/Object;
...
.method public final getRowIterator(J)Lhvf;
    .locals 3
    ...
    invoke-direct {p0, p1, p2}, Lhvd;->a(J)I

    move-result v2

    .line 104
    invoke-direct {v0, p0, v1, v2}, Lhvf;-><init>(Lhvd;Ljava/util/concurrent/atomic/AtomicIntegerArray;I)V
...
.method public final setFeatureValue(JLcom/google/android/libraries/smartburst/utils/Feature;)Z
    ...
    .line 34
    invoke-virtual/range {p3 .. p3}, Lcom/google/android/libraries/smartburst/utils/Feature;->getType()Lije;

    move-result-object v1

    invoke-direct {p0, v1}, Lhvd;->a(Lije;)V

    .line 35
    iget-object v1, p0, Lhvd;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 36
    iget-object v1, p0, Lhvd;->h:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    invoke-virtual {v2}, Lije;->name()Ljava/lang/String;
    ...
    .line 53
    :cond_3
    iget-object v3, p0, Lhvd;->d:Ljava/util/concurrent/atomic/AtomicIntegerArray;
    ...
    invoke-direct {p0, v3, v2}, Lhvd;->a(Lije;I)I
    ...
    .line 59
    iget-object v0, p0, Lhvd;->c:Ljava/util/concurrent/atomic/AtomicIntegerArray;
    ...
    .line 61
    iget-object v5, v8, Lije;->B:Lijk;

    move-object v0, p0

    .line 62
    invoke-direct/range {v0 .. v5}, Lhvd;->a(IIIFLijk;)V
