...
.field private d:Lgxc;

.field private e:Lgxe;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-interface {v0, p0}, Ldig;->a(Lffl;)V
    ...
    invoke-direct {v0, v1, v2}, Lgxe;-><init>(FF)V

    iput-object v0, p0, Lffl;->e:Lgxe;

    new-instance v0, Lgxc;

    new-instance v1, Lhak;

    invoke-direct {v1}, Lhak;-><init>()V

    invoke-direct {v0, p0, v1}, Lgxc;-><init>(Lgxd;Lhak;)V

    iput-object v0, p0, Lffl;->d:Lgxc;

    new-instance v0, Lffd;

    iget-object v1, p0, Lffl;->d:Lgxc;

    iget-object v2, p0, Lffl;->g:Landroid/graphics/Paint;

    invoke-direct {v0, v1, v2}, Lffd;-><init>(Lgxd;Landroid/graphics/Paint;)V
    ...
    invoke-direct {v0, v1, v2}, Lffr;-><init>(Lgxd;Landroid/graphics/Paint;)V

    iput-object v0, p0, Lffl;->b:Lffr;

    iget-object v0, p0, Lffl;->d:Lgxc;
...
.method public final a(F)V
    ...
    iget-object v1, p0, Lffl;->e:Lgxe;

    iget-object v0, p0, Lffl;->e:Lgxe;
    ...
    iget-object v6, v3, Lffk;->f:Lgxg;

    iget-object v7, v3, Lffk;->e:Lgxg;

    invoke-static {v6, v7, v5}, Lgxh;->a(Lgxg;Lgxg;F)F
...
.method public final c()V
    ...
    invoke-virtual {v0}, Lgxc;->invalidate()V
...
.method protected final onDraw(Landroid/graphics/Canvas;)V
    ...
    iput-boolean v1, v0, Lgxc;->d:Z

    iput-boolean v8, v0, Lgxc;->c:Z

    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J

    move-result-wide v2

    iput-wide v2, v0, Lgxc;->f:J

    iget-wide v2, v0, Lgxc;->e:J
    ...
    iget-wide v2, v0, Lgxc;->f:J

    iput-wide v2, v0, Lgxc;->e:J

    :cond_1
    iget-wide v2, v0, Lgxc;->f:J

    iget-wide v4, v0, Lgxc;->e:J
    ...
    iget-object v1, v0, Lgxc;->a:Ljava/util/List;
    ...
    invoke-interface/range {v1 .. v6}, Lgxb;->a(JJLandroid/graphics/Canvas;)V

    goto :goto_0

    :cond_3
    iget-boolean v1, v0, Lgxc;->c:Z

    if-eqz v1, :cond_4

    iget-object v1, v0, Lgxc;->b:Lgxd;

    invoke-interface {v1}, Lgxd;->invalidate()V

    :goto_1
    iput-boolean v8, v0, Lgxc;->d:Z
