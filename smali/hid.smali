...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;Lhif;Lcom/google/android/apps/refocus/processing/ProgressCallback;Landroid/graphics/Bitmap;)V
    .locals 2
    ...
    iput-object p2, p0, Lhid;->c:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;
    ...
    iput-object v0, p0, Lhid;->f:Landroid/os/Handler;

    iput-object p3, p0, Lhid;->a:Lhif;

    iput-object p4, p0, Lhid;->d:Lcom/google/android/apps/refocus/processing/ProgressCallback;

    iput-object p5, p0, Lhid;->e:Landroid/graphics/Bitmap;
...
.method public final run()V
    ...
    iget-object v1, p0, Lhid;->b:Landroid/content/Context;
    ...
    iget-object v1, p0, Lhid;->c:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;

    iget-object v2, p0, Lhid;->d:Lcom/google/android/apps/refocus/processing/ProgressCallback;

    iget-object v3, p0, Lhid;->e:Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lhid;->f:Landroid/os/Handler;

    new-instance v2, Lhie;

    invoke-direct {v2, p0, v0}, Lhie;-><init>(Lhid;Landroid/graphics/Bitmap;)V
