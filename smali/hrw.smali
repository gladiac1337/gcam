...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lhrw;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lhrw;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final onActivityCreated(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lhrw;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v0, v3, v2}, Ljava/util/concurrent/atomic/AtomicBoolean;->compareAndSet(ZZ)Z

    move-result v0

    iget-object v1, p0, Lhrw;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v1, v3}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    if-eqz v0, :cond_0

    invoke-direct {p0, v2}, Lhrw;->a(Z)V
...
.method public final onTrimMemory(I)V
    ...
    iget-object v0, p0, Lhrw;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
