...
.field public final synthetic q:Lvp;
...
# direct methods
.method constructor <init>(Lvp;Landroid/os/Looper;)V
    .locals 1

    const/4 v0, 0x0

    iput-object p1, p0, Lwd;->q:Lvp;

    invoke-direct {p0, p2}, Lzt;-><init>(Landroid/os/Looper;)V
    ...
    invoke-direct {v0, p0}, Lwg;-><init>(Lwd;)V

    iput-object v0, p0, Lwd;->x:Landroid/hardware/camera2/CameraDevice$StateCallback;

    new-instance v0, Lwh;

    invoke-direct {v0, p0}, Lwh;-><init>(Lwd;)V

    iput-object v0, p0, Lwd;->y:Landroid/hardware/camera2/CameraCaptureSession$StateCallback;

    new-instance v0, Lwi;

    invoke-direct {v0, p0}, Lwi;-><init>(Lwd;)V

    iput-object v0, p0, Lwd;->p:Lwj;
...
.method private final b()V
    ...
    :try_start_0
    iget-object v0, p0, Lwd;->i:Landroid/hardware/camera2/CameraCaptureSession;

    invoke-virtual {v0}, Landroid/hardware/camera2/CameraCaptureSession;->abortCaptures()V

    const/4 v0, 0x0

    iput-object v0, p0, Lwd;->i:Landroid/hardware/camera2/CameraCaptureSession;
    :try_end_0
    ...
    invoke-virtual {p0, v0}, Lwd;->a(I)V
    ...
    invoke-static {v1, v2, v0}, Lzw;->a(Lzx;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final a()Lzn;
    ...
    iget-object v1, p0, Lwd;->d:Landroid/hardware/camera2/CameraDevice;

    iget-object v2, p0, Lwd;->g:Landroid/graphics/Rect;

    iget-object v3, p0, Lwd;->t:Lzv;

    iget-object v4, p0, Lwd;->u:Lzv;

    invoke-direct {v0, v1, v2, v3, v4}, Lwm;-><init>(Landroid/hardware/camera2/CameraDevice;Landroid/graphics/Rect;Lzv;Lzv;)V
    :try_end_0
    .catch Landroid/hardware/camera2/CameraAccessException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v5}, Lkk;->a(I)Ljava/lang/String;
    ...
    iput-object v1, p0, Lwd;->d:Landroid/hardware/camera2/CameraDevice;
    ...
    iget-object v1, p0, Lwd;->c:Ljava/lang/String;

    invoke-static {v1}, Ljava/lang/Integer;->parseInt(Ljava/lang/String;)I

    move-result v1

    invoke-virtual {p0, v1}, Lwd;->b(I)Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lwd;->q:Lvp;

    iget-object v2, v2, Lvp;->g:Lzh;

    check-cast v0, Ljava/lang/RuntimeException;

    iget-object v3, p0, Lwd;->q:Lvp;

    iget-object v3, v3, Lvp;->c:Lzp;

    invoke-virtual {v3}, Lzp;->a()I

    move-result v3

    invoke-virtual {v2, v0, v1, v6, v3}, Lzh;->a(Ljava/lang/RuntimeException;Ljava/lang/String;II)V
    :try_end_1
    ...
    :cond_3
    :try_start_3
    iput-object v0, p0, Lwd;->a:Lxx;

    iput v1, p0, Lwd;->b:I

    iget-object v0, p0, Lwd;->q:Lvp;

    iget-object v0, v0, Lvp;->h:Ljava/util/List;
    ...
    iput-object v0, p0, Lwd;->c:Ljava/lang/String;
    ...
    iget-object v5, p0, Lwd;->c:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lzw;->c(Lzx;Ljava/lang/String;)V

    iget-object v0, p0, Lwd;->c:Ljava/lang/String;

    if-nez v0, :cond_4

    iget-object v0, p0, Lwd;->a:Lxx;
    ...
    iget-object v2, p0, Lwd;->x:Landroid/hardware/camera2/CameraDevice$StateCallback;
    ...
    :cond_6
    iget-object v0, p0, Lwd;->d:Landroid/hardware/camera2/CameraDevice;
    ...
    iput-object v0, p0, Lwd;->d:Landroid/hardware/camera2/CameraDevice;

    :cond_7
    const/4 v0, 0x0

    iput-object v0, p0, Lwd;->e:Lvs;

    const/4 v0, 0x0

    iput-object v0, p0, Lwd;->f:Lzz;

    const/4 v0, 0x0

    iput-object v0, p0, Lwd;->g:Landroid/graphics/Rect;

    iget-object v0, p0, Lwd;->w:Landroid/view/Surface;
    ...
    iput-object v0, p0, Lwd;->w:Landroid/view/Surface;

    :cond_8
    const/4 v0, 0x0

    iput-object v0, p0, Lwd;->v:Landroid/graphics/SurfaceTexture;

    iget-object v0, p0, Lwd;->j:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, Lwd;->j:Landroid/media/ImageReader;

    :cond_9
    const/4 v0, 0x0

    iput-object v0, p0, Lwd;->t:Lzv;

    const/4 v0, 0x0

    iput-object v0, p0, Lwd;->u:Lzv;
    ...
    :cond_a
    iget-object v1, p0, Lwd;->v:Landroid/graphics/SurfaceTexture;
    ...
    :cond_b
    iget-object v1, p0, Lwd;->i:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    iget-object v1, p0, Lwd;->t:Lzv;

    iget-object v1, v1, Lzv;->a:Landroid/graphics/Point;

    iget v1, v1, Landroid/graphics/Point;->x:I

    iget-object v2, p0, Lwd;->t:Lzv;
    ...
    iget-object v1, p0, Lwd;->w:Landroid/view/Surface;
    ...
    iput-object v1, p0, Lwd;->w:Landroid/view/Surface;
    ...
    :cond_e
    iget-object v0, p0, Lwd;->u:Lzv;

    iget-object v0, v0, Lzv;->a:Landroid/graphics/Point;

    iget v0, v0, Landroid/graphics/Point;->x:I

    iget-object v1, p0, Lwd;->u:Lzv;
    ...
    iget-object v4, p0, Lwd;->w:Landroid/view/Surface;

    aput-object v4, v1, v2

    const/4 v2, 0x1

    iget-object v4, p0, Lwd;->j:Landroid/media/ImageReader;
    ...
    iget-object v2, p0, Lwd;->y:Landroid/hardware/camera2/CameraCaptureSession$StateCallback;
    ...
    iget-object v1, p0, Lwd;->f:Lzz;

    iget-object v2, p0, Lwd;->d:Landroid/hardware/camera2/CameraDevice;
    ...
    iget-object v8, p0, Lwd;->w:Landroid/view/Surface;

    aput-object v8, v5, v7

    invoke-virtual {v1, v2, v4, v5}, Lzz;->a(Landroid/hardware/camera2/CameraDevice;I[Landroid/view/Surface;)Landroid/hardware/camera2/CaptureRequest;

    move-result-object v1

    iget-object v2, p0, Lwd;->p:Lwj;
    ...
    invoke-static {v1, v2, v0}, Lzw;->b(Lzx;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v7, p0, Lwd;->f:Lzz;

    sget-object v4, Landroid/hardware/camera2/CaptureRequest;->CONTROL_AE_REGIONS:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-object v5, v0, Lwm;->d:Ljava/util/List;

    invoke-virtual {v0, v5}, Lwm;->a(Ljava/util/List;)[Landroid/hardware/camera2/params/MeteringRectangle;

    move-result-object v5

    invoke-virtual {v0, v4, v5}, Lwm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V

    sget-object v4, Landroid/hardware/camera2/CaptureRequest;->CONTROL_AF_REGIONS:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-object v5, v0, Lwm;->e:Ljava/util/List;
    ...
    iget-object v4, v0, Lwm;->b:Lzz;

    sget-object v5, Landroid/hardware/camera2/CaptureRequest;->SCALER_CROP_REGION:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-object v8, v0, Lwm;->c:Landroid/graphics/Rect;

    invoke-virtual {v4, v5, v8}, Lzz;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Z
    ...
    iget-object v4, v0, Lwm;->p:Lza;

    if-eqz v4, :cond_11

    iget-object v4, v0, Lwm;->p:Lza;

    invoke-virtual {v4}, Lza;->ordinal()I

    move-result v4

    packed-switch v4, :pswitch_data_0

    sget-object v4, Lwm;->a:Lzx;
    ...
    invoke-static {v4, v5}, Lzw;->e(Lzx;Ljava/lang/String;)V
    ...
    :goto_2
    iget-object v8, v0, Lwm;->b:Lzz;

    sget-object v9, Landroid/hardware/camera2/CaptureRequest;->CONTROL_AE_MODE:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-virtual {v8, v9, v5}, Lzz;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Z

    iget-object v5, v0, Lwm;->b:Lzz;

    sget-object v8, Landroid/hardware/camera2/CaptureRequest;->FLASH_MODE:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-virtual {v5, v8, v4}, Lzz;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Z

    iget-object v4, v0, Lwm;->q:Lzb;

    if-eqz v4, :cond_12

    iget-object v4, v0, Lwm;->q:Lzb;

    invoke-virtual {v4}, Lzb;->ordinal()I
    ...
    iget-object v4, v0, Lwm;->r:Lzc;

    if-eqz v4, :cond_13

    iget-object v4, v0, Lwm;->r:Lzc;

    invoke-virtual {v4}, Lzc;->ordinal()I
    ...
    iget-object v4, v0, Lwm;->s:Lze;

    if-eqz v4, :cond_14

    iget-object v4, v0, Lwm;->s:Lze;

    invoke-virtual {v4}, Lze;->ordinal()I
    ...
    invoke-virtual {v0, v4, v1}, Lwm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    :goto_6
    invoke-virtual {v4, v5, v1}, Lzz;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Z

    sget-object v1, Landroid/hardware/camera2/CaptureRequest;->CONTROL_AE_LOCK:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-boolean v2, v0, Lwm;->u:Z

    invoke-static {v2}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lwm;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V

    sget-object v1, Landroid/hardware/camera2/CaptureRequest;->CONTROL_AWB_LOCK:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-boolean v2, v0, Lwm;->v:Z
    ...
    iget-object v1, v0, Lwm;->x:Lzo;

    if-eqz v1, :cond_16

    iget-object v1, v0, Lwm;->x:Lzo;

    iget-object v1, v1, Lzo;->e:Ljava/lang/String;

    if-nez v1, :cond_19

    :cond_16
    iget-object v1, v0, Lwm;->b:Lzz;

    sget-object v2, Landroid/hardware/camera2/CaptureRequest;->JPEG_GPS_LOCATION:Landroid/hardware/camera2/CaptureRequest$Key;

    const/4 v4, 0x0

    invoke-virtual {v1, v2, v4}, Lzz;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Z

    :goto_7
    iget-object v1, v0, Lwm;->y:Lzv;
    ...
    iget-object v4, v0, Lwm;->y:Lzv;

    iget-object v4, v4, Lzv;->a:Landroid/graphics/Point;

    iget v4, v4, Landroid/graphics/Point;->x:I

    iget-object v5, v0, Lwm;->y:Lzv;
    ...
    :cond_17
    :goto_9
    invoke-virtual {v0}, Lwm;->b()Lzv;

    move-result-object v1

    iput-object v1, p0, Lwd;->t:Lzv;

    invoke-virtual {v0}, Lwm;->c()Lzv;
    ...
    :cond_1b
    iget-object v2, v7, Lzz;->a:Ljava/util/Map;

    iget-object v1, v1, Lzz;->a:Ljava/util/Map;

    invoke-interface {v2, v1}, Ljava/util/Map;->putAll(Ljava/util/Map;)V

    iget-wide v4, v7, Lzz;->b:J

    const-wide/16 v8, 0x1

    add-long/2addr v4, v8

    iput-wide v4, v7, Lzz;->b:J
    ...
    invoke-direct {v1, p0, v0}, Lwe;-><init>(Lwd;Lxv;)V
    ...
    iget-object v2, p0, Lwd;->f:Lzz;

    invoke-direct {v0, v2}, Lzz;-><init>(Lzz;)V
    ...
    invoke-virtual {v0, v2, v4}, Lzz;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Z
    :try_end_a
    .catch Ljava/lang/Exception; {:try_start_a .. :try_end_a} :catch_0
    .catchall {:try_start_a .. :try_end_a} :catchall_0

    :try_start_b
    iget-object v2, p0, Lwd;->i:Landroid/hardware/camera2/CameraCaptureSession;

    iget-object v4, p0, Lwd;->d:Landroid/hardware/camera2/CameraDevice;
    ...
    iget-object v9, p0, Lwd;->w:Landroid/view/Surface;

    aput-object v9, v7, v8

    invoke-virtual {v0, v4, v5, v7}, Lzz;->a(Landroid/hardware/camera2/CameraDevice;I[Landroid/view/Surface;)Landroid/hardware/camera2/CaptureRequest;
    ...
    invoke-direct {v0, v1}, Lzz;-><init>(Lzz;)V
    ...
    invoke-virtual {v0, v1, v2}, Lzz;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Z
    :try_end_c
    ...
    invoke-virtual {v0, v2, v4, v5}, Lzz;->a(Landroid/hardware/camera2/CameraDevice;I[Landroid/view/Surface;)Landroid/hardware/camera2/CaptureRequest;
    ...
    iget-object v0, p0, Lwd;->e:Lvs;

    iget-object v0, v0, Lvs;->a:Lzg;

    iget v1, p1, Landroid/os/Message;->arg1:I

    const/4 v5, 0x0

    invoke-virtual {v0, v1, v5}, Lzg;->a(IZ)I
    ...
    invoke-virtual {v2, v4, v0}, Lzz;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, v2, v4}, Lzz;->b(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v2}, Lzw;->c(Lzx;Ljava/lang/String;)V

    iget-object v1, p0, Lwd;->j:Landroid/media/ImageReader;
    ...
    iget-object v9, p0, Lwd;->j:Landroid/media/ImageReader;
    ...
    invoke-virtual {v2, v4, v5, v7}, Lzz;->a(Landroid/hardware/camera2/CameraDevice;I[Landroid/view/Surface;)Landroid/hardware/camera2/CaptureRequest;
    ...
    invoke-direct {v1, p0, v0}, Lwf;-><init>(Lwd;Lwk;)V
    ...
    invoke-virtual {p0, v2}, Lwd;->b(I)Ljava/lang/String;
