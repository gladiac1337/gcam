...
.method public static a(Lias;Lijt;Ljava/lang/String;)Liav;
    .locals 4
    ...
    invoke-interface {p0, p2, v0, v1, v2}, Lias;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liav;
...
.method public static a(Lias;Ljava/lang/String;Landroid/graphics/Bitmap;)Liav;
    .locals 7
    ...
    invoke-static/range {v0 .. v6}, Liat;->a(Lias;Ljava/lang/String;Landroid/graphics/Bitmap;IILandroid/graphics/Matrix;Z)Liav;
...
.method public static a(Lias;Ljava/lang/String;Landroid/graphics/Bitmap;II)Liav;
    .locals 7
    ...
    .line 40
    :try_start_0
    sget-object v5, Liat;->a:Landroid/graphics/Matrix;

    .line 41
    const/4 v0, 0x0

    sput-object v0, Liat;->a:Landroid/graphics/Matrix;
    ...
    .line 53
    :try_start_1
    sget-object v2, Liat;->a:Landroid/graphics/Matrix;

    if-nez v2, :cond_1

    .line 54
    sput-object v5, Liat;->a:Landroid/graphics/Matrix;
...
.method private static a(Lias;Ljava/lang/String;Landroid/graphics/Bitmap;IILandroid/graphics/Matrix;Z)Liav;
    .locals 9
    ...
    .line 83
    :cond_5
    invoke-interface {p0, p1, p3, p4, v2}, Lias;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liav;
    ...
    .line 93
    :goto_3
    invoke-interface {p0, p1, v7, v8, v0}, Lias;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liav;
...
.method public static a(Lias;Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Liav;
    .locals 6
    ...
    .line 6
    invoke-interface {p0, v0, v1}, Lias;->a(Ljava/lang/String;Landroid/graphics/Bitmap;)Liav;
    ...
    .line 19
    invoke-static {v1, v0}, Liat;->a(Landroid/graphics/Bitmap;Liav;)V

    .line 20
    invoke-static {v0, v2, v3}, Liat;->a(Liav;II)V

    .line 21
    invoke-static {v0, v4}, Liat;->a(Liav;Landroid/graphics/Bitmap$Config;)V
    ...
    .line 16
    :cond_3
    invoke-interface {p0, v0, v2, v3, v4}, Lias;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liav;
...
.method public static a(Lias;Ljava/lang/String;Landroid/graphics/Rect;)Liav;
    .locals 5
    ...
    invoke-interface {p0, v0, v3, v4, v2}, Lias;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liav;
    ...
    .line 32
    invoke-static {v1, v3}, Liat;->a(Landroid/graphics/Bitmap;Liav;)V
    ...
    invoke-static {v3, v0, v1}, Liat;->a(Liav;II)V

    .line 34
    invoke-static {v3, v2}, Liat;->a(Liav;Landroid/graphics/Bitmap$Config;)V
    :try_end_0
...
.method public static a(Lias;Ljava/lang/String;Liav;II)Liav;
    .locals 1

    .prologue
    .line 57
    invoke-interface {p2}, Liav;->e()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/graphics/Bitmap;

    invoke-static {p0, p1, v0, p3, p4}, Liat;->a(Lias;Ljava/lang/String;Landroid/graphics/Bitmap;II)Liav;
...
.method public static a(Lias;Ljava/lang/String;Ljava/nio/ByteBuffer;II)Liav;
    .locals 2
    ...
    invoke-interface {p0, p1, p3, p4, v0}, Lias;->a(Ljava/lang/String;IILandroid/graphics/Bitmap$Config;)Liav;
...
.method private static a(Landroid/graphics/Bitmap;Liav;)V
    .locals 5
...
.method private static a(Liav;II)V
    .locals 5

    .prologue
    .line 119
    invoke-interface {p0}, Liav;->e()Ljava/lang/Object;
...
.method private static a(Liav;Landroid/graphics/Bitmap$Config;)V
    .locals 5
