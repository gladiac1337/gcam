...
.field private d:Lhjz;

.field private e:Ljava/util/concurrent/Executor;


# direct methods
.method public constructor <init>(Landroid/hardware/camera2/CameraManager;Lhjz;Ljava/util/concurrent/Executor;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcee;->c:Landroid/hardware/camera2/CameraManager;

    iput-object p2, p0, Lcee;->d:Lhjz;

    iput-object p3, p0, Lcee;->e:Ljava/util/concurrent/Executor;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcee;->a:Ljava/lang/Object;

    return-void
.end method

.method private final c()Liwe;
    .locals 3
    ...
    iget-object v0, p0, Lcee;->e:Ljava/util/concurrent/Executor;

    new-instance v1, Lcef;

    invoke-direct {v1, p0}, Lcef;-><init>(Lcee;)V
...
.method public final a()Liwe;
    ...
    :try_start_0
    iget-object v0, p0, Lcee;->c:Landroid/hardware/camera2/CameraManager;
...
.method final b()Z
    ...
    invoke-direct {v2, v4}, Lceg;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;)V
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_3

    :try_start_2
    iget-object v1, p0, Lcee;->c:Landroid/hardware/camera2/CameraManager;

    const-string v6, "PollUntilReconnect"

    invoke-static {v5, v6}, Lhhy;->a(Lhib;Ljava/lang/String;)Landroid/os/Handler;
    ...
    iget-object v6, p0, Lcee;->c:Landroid/hardware/camera2/CameraManager;
    ...
    iget-object v1, p0, Lcee;->d:Lhjz;

    sget-object v4, Lhka;->a:Lhka;

    invoke-interface {v1, v4}, Lhjz;->a(Lhka;)V
    :try_end_2
    .catch Ljava/lang/Throwable; {:try_start_2 .. :try_end_2} :catch_6
    .catchall {:try_start_2 .. :try_end_2} :catchall_4

    :try_start_3
    invoke-virtual {v5}, Lhib;->close()V
    :try_end_3
    ...
    invoke-interface {v1, v3}, Lhjz;->a(Lhka;)V
    :try_end_9
