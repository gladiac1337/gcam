...
# direct methods
.method public constructor <init>(Lcom/google/android/libraries/smartburst/buffers/FeatureTable;Ljbr;)V
    .locals 1
    ...
    .line 2
    iput-object p2, p0, Ljbs;->a:Ljbr;

    .line 3
    iput-object p1, p0, Ljbs;->b:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;
...
.method public final a(Ljao;)Ljava/util/List;
    ...
    .line 13
    :cond_0
    iget-object v0, p0, Ljbs;->b:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;
    ...
    .line 18
    iget-object v5, p0, Ljbs;->b:Lcom/google/android/libraries/smartburst/buffers/FeatureTable;

    sget-object v8, Ljfh;->c:Ljfh;

    .line 19
    invoke-interface {v5, v6, v7, v8}, Lcom/google/android/libraries/smartburst/buffers/FeatureTable;->getFeature(JLjfh;)Lcom/google/android/libraries/smartburst/utils/Feature;
    ...
    iget-object v5, p0, Ljbs;->a:Ljbr;

    iget v6, p0, Ljbs;->c:F

    iget v7, p0, Ljbs;->d:F

    invoke-direct/range {v0 .. v7}, Ljbt;-><init>([F[F[JLjava/util/List;Ljbr;FF)V
    ...
    .line 64
    iget-object v5, v0, Ljbt;->b:[J

    iget-object v6, v0, Ljbt;->b:[J
    ...
    invoke-virtual {v0, v2, v7}, Ljbt;->a(II)D
    ...
    invoke-virtual {v0, v8, v7}, Ljbt;->a(II)D
    ...
    .line 80
    iget-object v1, v0, Ljbt;->c:Ljava/util/List;

    iget-object v0, v0, Ljbt;->b:[J

    const/4 v2, 0x0

    aget-wide v4, v0, v2

    invoke-static {v1, v3, v4, v5}, Ljbt;->a(Ljava/util/List;Ljava/util/Deque;J)Ljava/util/List;
