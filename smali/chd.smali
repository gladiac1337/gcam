...
.method public static a(Ljava/util/List;Lcda;)Lche;
    .locals 8
    ...
    sget-object v0, Lchd;->a:Ljava/lang/String;
    ...
    invoke-interface {v0}, Lcda;->a()Lcda;
    ...
    invoke-direct {v0, v1, v2}, Lche;-><init>(Ljava/util/List;Ljava/util/List;)V

    :goto_5
    return-object v0

    :cond_8
    invoke-interface {v3}, Lcda;->b()Lcda;

    move-result-object v0

    invoke-interface {v3}, Lcda;->a()Lcda;
    ...
    :goto_6
    invoke-interface {v0, v4}, Lcda;->a(I)Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3}, Lche;-><init>(Ljava/util/List;Ljava/util/List;)V
