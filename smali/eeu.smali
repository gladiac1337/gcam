...
# direct methods
.method constructor <init>(Lico;Lick;Lcoo;Lgdm;Lgzo;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Leeu;->a:Lico;

    iput-object p3, p0, Leeu;->c:Lcoo;

    iput-object p4, p0, Leeu;->d:Lgdm;

    iput-object p5, p0, Leeu;->e:Lgzo;
    ...
    iput-object v0, p0, Leeu;->b:Licj;

    return-void
.end method

.method private final a(Lcoz;Lcom/google/googlex/gcam/FrameRequestVector;Lggi;Lgic;Ldol;)Lcom/google/googlex/gcam/BurstSpec;
    .locals 10

    invoke-virtual {p3, p4}, Lggi;->a(Lgfw;)Lggi;

    iget-object v0, p0, Leeu;->e:Lgzo;
    ...
    invoke-virtual {p3, v0, v1}, Lggi;->a(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Lggi;
    ...
    invoke-interface {v2, v5}, Licj;->e(Ljava/lang/String;)V
    ...
    invoke-direct {v6, v7, v0}, Lcnw;-><init>(II)V

    new-instance v7, Lggi;

    invoke-direct {v7, p3}, Lggi;-><init>(Lggi;)V

    iget-object v8, p0, Leeu;->d:Lgdm;

    invoke-static {v7, v5, v8, v6}, Lcoj;->a(Lggi;Lcom/google/googlex/gcam/FrameRequest;Lgdm;Lcnw;)V

    invoke-virtual {v7, v2}, Lggi;->a(Lggq;)Lggi;
    ...
    iget-object v5, p0, Leeu;->b:Licj;

    const-string v6, "Adding metadata future to list."

    invoke-interface {v5, v6}, Licj;->e(Ljava/lang/String;)V

    iget-object v2, v2, Ledw;->a:Ljuw;
    ...
    invoke-interface {p5, v1, v0}, Ldol;->a(Ljava/util/List;Lggp;)V
    ...
    invoke-interface {p4}, Lgic;->a()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lgid;

    invoke-virtual {v1}, Lgid;->g()Z

    move-result v5

    if-eqz v5, :cond_2

    iget-object v5, p0, Leeu;->c:Lcoo;

    invoke-interface {v5, p1, v2, v0, v1}, Lcoo;->a(Lcoz;ILihr;Liia;)V
    ...
    invoke-interface {v1, v2, v0}, Licj;->b(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v1, p0, Leeu;->a:Lico;
    ...
    iget-object v1, p0, Leeu;->c:Lcoo;

    const/4 v5, 0x0

    invoke-interface {v1, p1, v2, v0, v5}, Lcoo;->a(Lcoz;ILihr;Liia;)V

    goto/16 :goto_2

    :cond_3
    iget-object v0, p0, Leeu;->c:Lcoo;

    invoke-interface {v0, p1}, Lcoo;->e(Lcoz;)Lcom/google/googlex/gcam/BurstSpec;
...
.method private final a(Lcoz;IILgic;Ljava/util/HashMap;[Landroid/hardware/camera2/params/Face;)Lihr;
    .locals 14

    iget-object v2, p0, Leeu;->a:Lico;
    ...
    :try_start_0
    invoke-interface/range {p4 .. p4}, Lgic;->a()Ljava/lang/Object;
    ...
    invoke-virtual {v6}, Lgid;->g()Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {v6}, Lgid;->e()J
    ...
    :cond_0
    :try_start_2
    invoke-virtual {v6}, Lgid;->close()V
    ...
    invoke-interface/range {v7 .. v13}, Lcoo;->a(Lcoz;ILihr;Liia;Liia;[Landroid/hardware/camera2/params/Face;)V
    :try_end_2
    ...
    invoke-interface {v3, v4, v2}, Licj;->b(Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {v6}, Lgid;->close()V

    new-instance v3, Lidu;

    invoke-direct {v3, v2}, Lidu;-><init>(Ljava/lang/Throwable;)V
...
.method private final a(Lgic;I)Ljava/util/HashMap;
    .locals 6
    ...
    :try_start_0
    invoke-interface {p1}, Lgic;->a()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lgid;
    :try_end_0
    .catch Lidu; {:try_start_0 .. :try_end_0} :catch_3
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_1
...
.method private final a(Lcoz;IILihr;)V
    .locals 7
    ...
    invoke-interface/range {v0 .. v6}, Lcoo;->a(Lcoz;ILihr;Liia;Liia;[Landroid/hardware/camera2/params/Face;)V

    return-void
.end method

.method private final a(Lcoz;Lcom/google/googlex/gcam/FrameRequestVector;Leao;Lggi;Lgic;Lgic;Ldol;Libw;Lavk;[Landroid/hardware/camera2/params/Face;)Z
    .locals 15
    ...
    invoke-interface/range {p5 .. p5}, Lgic;->d()I
    ...
    invoke-virtual/range {p4 .. p5}, Lggi;->a(Lgfw;)Lggi;
    ...
    invoke-virtual {v0, v1}, Lggi;->a(Lgfw;)Lggi;

    :cond_0
    move-object/from16 v0, p3

    iget-object v2, v0, Leao;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v2, v0, Leao;->b:Lhzi;

    new-instance v3, Leds;

    move-object/from16 v0, p3

    invoke-direct {v3, v0}, Leds;-><init>(Leao;)V
    ...
    iget-object v3, v0, Leao;->a:Ldhi;

    iget-object v3, v3, Ldhi;->b:Ldhj;

    move-object/from16 v0, p3

    iget-object v4, v0, Leao;->b:Lhzi;

    move-object/from16 v0, p3

    invoke-direct {v2, v0, v3, v4, v10}, Ledu;-><init>(Leao;Ldhj;Lhzi;I)V

    invoke-static {v2}, Lfsl;->c(Licc;)Lggq;
    ...
    invoke-direct {v6, v8, v9}, Lcnw;-><init>(II)V

    iget-object v8, p0, Leeu;->d:Lgdm;

    move-object/from16 v0, p4

    invoke-static {v0, v2, v8, v6}, Lcoj;->a(Lggi;Lcom/google/googlex/gcam/FrameRequest;Lgdm;Lcnw;)V

    new-instance v2, Lggi;

    move-object/from16 v0, p4

    invoke-direct {v2, v0}, Lggi;-><init>(Lggi;)V
    ...
    new-instance v13, Lcnw;

    const/4 v14, 0x2

    invoke-direct {v13, v14, v9}, Lcnw;-><init>(II)V
    ...
    :cond_1
    iget-object v2, p0, Leeu;->d:Lgdm;

    move-object/from16 v0, p4

    invoke-static {v0, v12, v2, v13}, Lcoj;->a(Lggi;Lcom/google/googlex/gcam/FrameRequest;Lgdm;Lcnw;)V
    ...
    invoke-direct {v6, v0}, Lggi;-><init>(Lggi;)V
    ...
    invoke-interface {v0, v11, v2}, Ldol;->a(Ljava/util/List;Lggp;)V
    :try_end_0
    .catch Lidu; {:try_start_0 .. :try_end_0} :catch_0

    invoke-interface/range {p8 .. p8}, Libw;->close()V
    ...
    invoke-interface {v3, v6}, Lico;->a(Ljava/lang/String;)V

    if-eqz p6, :cond_11

    move-object/from16 v0, p6

    invoke-direct {p0, v0, v10}, Leeu;->a(Lgic;I)Ljava/util/HashMap;
    :try_end_1
    .catch Lidu; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/lang/InterruptedException; {:try_start_1 .. :try_end_1} :catch_2
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :try_start_2
    invoke-direct/range {v2 .. v8}, Leeu;->a(Lcoz;IILgic;Ljava/util/HashMap;[Landroid/hardware/camera2/params/Face;)Lihr;
    :try_end_2
    .catch Lidu; {:try_start_2 .. :try_end_2} :catch_5
    ...
    invoke-interface {v0, v2}, Lavk;->a(Lihr;)V
    :try_end_3
    .catch Lidu; {:try_start_3 .. :try_end_3} :catch_1
    ...
    invoke-virtual/range {p1 .. p1}, Lcoz;->b()Z
    ...
    invoke-direct {p0, v0, v4, v5, v9}, Leeu;->a(Lcoz;IILihr;)V
    ...
    invoke-interface {v2, v0}, Lcoo;->f(Lcoz;)Z
    ...
    invoke-virtual/range {p1 .. p1}, Lcoz;->c()Z
    :try_end_4
    ...
    invoke-virtual/range {p1 .. p1}, Lcoz;->b()Z
    :try_end_5
    .catch Lidu; {:try_start_5 .. :try_end_5} :catch_5
    ...
    invoke-interface {v3, v4}, Licj;->f(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, v2, v5, v9}, Leeu;->a(Lcoz;IILihr;)V
...
# virtual methods
.method final a(Lcoz;Lggi;Ldsf;Ldol;)Lcom/google/googlex/gcam/BurstSpec;
    .locals 7
    ...
    invoke-interface {v0, p1}, Lcoo;->d(Lcoz;)Lcom/google/googlex/gcam/BurstSpec;
    ...
    invoke-interface {v1, v3}, Licj;->b(Ljava/lang/String;)V

    :try_start_0
    invoke-virtual {p3, v0}, Ldsf;->a(I)Lgic;
    :try_end_0
    ...
    :try_start_1
    invoke-direct/range {v0 .. v5}, Leeu;->a(Lcoz;Lcom/google/googlex/gcam/FrameRequestVector;Lggi;Lgic;Ldol;)Lcom/google/googlex/gcam/BurstSpec;
    :try_end_1
...
.method final a(Lcoz;Lcom/google/googlex/gcam/BurstSpec;Leao;Lggi;Ldsf;Ljhi;Ldol;Libw;Lavk;Legm;)Z
    .locals 16

    move-object/from16 v0, p0

    iget-object v2, v0, Leeu;->a:Lico;
    ...
    iget-object v2, v0, Legm;->b:Lihr;

    if-eqz v2, :cond_0

    sget-object v5, Landroid/hardware/camera2/CaptureResult;->STATISTICS_FACES:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {v2, v5}, Lihr;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-static {v0, v3}, Ldeo;->a(Ldsf;I)Lgic;
    :try_end_0
    ...
    invoke-static {v2, v3}, Ldeo;->a(Ldsf;I)Lgic;
    :try_end_1
    ...
    :try_start_3
    invoke-interface {v8}, Lgic;->close()V
    :try_end_3
    ...
    iget-object v2, v0, Leeu;->c:Lcoo;

    move-object/from16 v0, p1

    move-object/from16 v1, p2

    invoke-interface {v2, v0, v1}, Lcoo;->a(Lcoz;Lcom/google/googlex/gcam/BurstSpec;)V
    ...
    invoke-direct/range {v2 .. v12}, Leeu;->a(Lcoz;Lcom/google/googlex/gcam/FrameRequestVector;Leao;Lggi;Lgic;Lgic;Ldol;Libw;Lavk;[Landroid/hardware/camera2/params/Face;)Z
    :try_end_5
