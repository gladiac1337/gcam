...
.method public constructor <init>(Ljef;Ljava/util/List;)V
    ...
    iput-object v0, p0, Ljei;->b:Ljava/util/List;
...
.method public final a(Ljava/io/File;)J
    ...
    .line 6
    :try_start_1
    iget-object v0, p0, Ljei;->b:Ljava/util/List;

    iget-object v2, p0, Ljei;->a:Ljef;

    invoke-interface {v2, p1}, Ljef;->b(Ljava/io/File;)I
    ...
    .line 9
    invoke-virtual {v1}, Ljeh;->getMessage()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Ljeh;->getMessage()Ljava/lang/String;
    ...
    invoke-direct {v2, v0}, Ljeh;-><init>(Ljava/lang/String;)V
