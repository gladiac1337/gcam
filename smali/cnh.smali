...
.method public constructor <init>(Libw;)V
    ...
    iput-object p1, p0, Lcnh;->b:Libw;

    new-instance v0, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v0}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v0, p0, Lcnh;->d:Ljava/util/concurrent/locks/ReentrantLock;

    iget-object v0, p0, Lcnh;->d:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->newCondition()Ljava/util/concurrent/locks/Condition;

    move-result-object v0

    iput-object v0, p0, Lcnh;->e:Ljava/util/concurrent/locks/Condition;

    new-instance v0, Lcni;

    invoke-direct {v0, p0}, Lcni;-><init>(Lcng;)V

    iput-object v0, p0, Lcnh;->c:Lcnf;

    return-void
.end method

.method private final b(Lcnf;)V
    .locals 6
    ...
    :cond_1
    iget-object v0, p0, Lcnh;->e:Ljava/util/concurrent/locks/Condition;
    ...
    iget-object v1, p0, Lcnh;->d:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final a(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Lcnf;->a(Ljava/lang/Class;)Lcne;
    ...
    invoke-interface {v0, p1}, Lcne;->a(Ljava/lang/Object;)Lcnf;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-direct {p0, v0}, Lcnh;->b(Lcnf;)V
    :try_end_0
...
.method public final a(Lcnf;)Z
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p1}, Lcnh;->b(Lcnf;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
