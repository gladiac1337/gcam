...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lbhm;)V
    .locals 0
    ...
    .line 56
    iput-object p2, p0, Lhhy;->b:Landroid/os/Handler;

    .line 57
    iput-object p3, p0, Lhhy;->c:Lbhm;
...
.method public a(F)V
    ...
    .line 4
    iget-object v0, p0, Lhhy;->k:Lcom/google/android/apps/refocus/processing/FocusSettings;

    iget-object v1, p0, Lhhy;->i:Lhht;

    iget-object v2, p0, Lhhy;->k:Lcom/google/android/apps/refocus/processing/FocusSettings;

    iget v2, v2, Lcom/google/android/apps/refocus/processing/FocusSettings;->focalDistance:F

    iget-object v3, p0, Lhhy;->k:Lcom/google/android/apps/refocus/processing/FocusSettings;
    ...
    .line 5
    invoke-virtual {v1, v2, v3, v4}, Lhht;->a(FFF)F
...
.method public a(II)V
    ...
    .line 10
    iget-object v2, p0, Lhhy;->f:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;
    ...
    iget-object v2, p0, Lhhy;->e:Landroid/graphics/Bitmap;
    ...
    .line 16
    iget-object v4, p0, Lhhy;->d:Landroid/widget/ImageView;
    ...
    iget-object v5, p0, Lhhy;->e:Landroid/graphics/Bitmap;
    ...
    .line 25
    iget-object v0, p0, Lhhy;->f:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;
    ...
    .line 30
    iget-object v1, p0, Lhhy;->k:Lcom/google/android/apps/refocus/processing/FocusSettings;
...
.method public a(Landroid/graphics/Bitmap;)V
    ...
    .line 60
    invoke-virtual {p0, p1}, Lhhy;->b(Landroid/graphics/Bitmap;)V
...
.method public a(FF)[F
    ...
    iget-object v1, p0, Lhhy;->d:Landroid/widget/ImageView;
...
.method public b(Landroid/graphics/Bitmap;)V
    ...
    .prologue
    .line 62
    iput-object p1, p0, Lhhy;->e:Landroid/graphics/Bitmap;

    .line 63
    iget-object v0, p0, Lhhy;->d:Landroid/widget/ImageView;
    ...
    iget-object v1, p0, Lhhy;->e:Landroid/graphics/Bitmap;
...
.method public b()[F
    ...
    .line 40
    iget-object v0, p0, Lhhy;->e:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0, v0, v1}, Lhhy;->a(FF)[F
    ...
    iget-object v1, p0, Lhhy;->f:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;
    ...
    .line 49
    iget-object v3, p0, Lhhy;->e:Landroid/graphics/Bitmap;
...
.method public c()V
    ...
    .line 70
    :try_start_0
    iget-object v0, p0, Lhhy;->m:Ljava/util/concurrent/CountDownLatch;
...
.method public d()V
    ...
    .line 77
    iget-object v0, p0, Lhhy;->h:Lcom/google/android/apps/refocus/viewer/RGBZViewer$RenderProgress;
    ...
    iget-object v3, p0, Lhhy;->f:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;
    ...
    invoke-direct {v0, p0, v4}, Lcom/google/android/apps/refocus/viewer/RGBZViewer$RenderProgress;-><init>(Lhhy;Lhia;)V

    iput-object v0, p0, Lhhy;->h:Lcom/google/android/apps/refocus/viewer/RGBZViewer$RenderProgress;

    .line 84
    iget-object v0, p0, Lhhy;->b:Landroid/os/Handler;

    invoke-virtual {v0, v4}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    .line 85
    iget-object v6, p0, Lhhy;->b:Landroid/os/Handler;

    new-instance v0, Lhid;

    iget-object v1, p0, Lhhy;->a:Landroid/content/Context;

    iget-object v2, p0, Lhhy;->f:Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;

    iget-object v4, p0, Lhhy;->h:Lcom/google/android/apps/refocus/viewer/RGBZViewer$RenderProgress;

    iget-object v5, p0, Lhhy;->g:Landroid/graphics/Bitmap;

    move-object v3, p0

    invoke-direct/range {v0 .. v5}, Lhid;-><init>(Landroid/content/Context;Lcom/google/android/apps/refocus/processing/DepthOfFieldOptions;Lhif;Lcom/google/android/apps/refocus/processing/ProgressCallback;Landroid/graphics/Bitmap;)V
