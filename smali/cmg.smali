...
.method public constructor <init>(Lfsq;)V
    ...
    iput-object v0, p0, Lcmg;->b:Ljava/util/List;
    ...
    iput-object v0, p0, Lcmg;->f:Landroid/graphics/Rect;

    .line 7
    iget-object v0, p0, Lcmg;->f:Landroid/graphics/Rect;

    iget-object v1, p0, Lcmg;->f:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->bottom:I

    iget-object v2, p0, Lcmg;->f:Landroid/graphics/Rect;
...
.method private final declared-synchronized a(Lhop;)V
    .locals 5
    ...
    iput-boolean v2, p0, Lcmg;->e:Z

    .line 27
    :cond_0
    :goto_0
    iput-object p1, p0, Lcmg;->c:Lhop;

    .line 28
    iput-object v0, p0, Lcmg;->d:Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    :cond_1
    :try_start_2
    invoke-direct {p0, v0}, Lcmg;->a(Landroid/hardware/camera2/params/MeteringRectangle;)Z
    ...
    iget-object v4, p0, Lcmg;->f:Landroid/graphics/Rect;
    ...
    .line 22
    iget-object v2, p0, Lcmg;->b:Ljava/util/List;
    ...
    :cond_2
    :try_start_4
    iget-object v3, p0, Lcmg;->b:Ljava/util/List;
...
.method private final a(Landroid/hardware/camera2/params/MeteringRectangle;)Z
    ...
    iget-object v2, p0, Lcmg;->d:Landroid/hardware/camera2/params/MeteringRectangle;
...
.method public final bridge synthetic a(Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, Lcmg;->a(Lhop;)V
