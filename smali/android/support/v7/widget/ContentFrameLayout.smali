...
.method protected onDetachedFromWindow()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ContentFrameLayout;->h:Lph;

    if-eqz v0, :cond_3

    iget-object v0, p0, Landroid/support/v7/widget/ContentFrameLayout;->h:Lph;

    iget-object v0, v0, Lph;->a:Ljv;

    iget-object v1, v0, Ljv;->o:Lpi;

    if-eqz v1, :cond_0

    iget-object v1, v0, Ljv;->o:Lpi;

    invoke-interface {v1}, Lpi;->j()V

    :cond_0
    iget-object v1, v0, Ljv;->r:Landroid/widget/PopupWindow;

    if-eqz v1, :cond_2

    iget-object v1, v0, Ljv;->c:Landroid/view/Window;

    invoke-virtual {v1}, Landroid/view/Window;->getDecorView()Landroid/view/View;

    move-result-object v1

    iget-object v2, v0, Ljv;->s:Ljava/lang/Runnable;
    ...
    iput-object v1, v0, Ljv;->r:Landroid/widget/PopupWindow;
    ...
    invoke-virtual {v0, v1}, Ljv;->g(I)Lke;
