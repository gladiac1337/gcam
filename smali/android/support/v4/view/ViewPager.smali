...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->V:Lfk;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Lfc;
    ...
    invoke-direct {v0, p0}, Lfa;-><init>(Landroid/support/v4/view/ViewPager;)V
...
.method private final a(II)Lfc;
    ...
    .line 225
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    invoke-virtual {v1, p0, p1}, Lek;->instantiateItem(Landroid/view/ViewGroup;I)Ljava/lang/Object;

    move-result-object v1

    iput-object v1, v0, Lfc;->a:Ljava/lang/Object;

    .line 226
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    invoke-virtual {v1, p1}, Lek;->getPageWidth(I)F
...
.method private final a(Landroid/view/View;)Lfc;
    .locals 4
    ...
    .line 491
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    iget-object v3, v0, Lfc;->a:Ljava/lang/Object;

    invoke-virtual {v2, p1, v3}, Lek;->isViewFromObject(Landroid/view/View;Ljava/lang/Object;)Z
...
.method private final a(IZIZ)V
    ...
    .prologue
    .line 150
    invoke-direct {p0, p1}, Landroid/support/v4/view/ViewPager;->d(I)Lfc;
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    iget v6, p0, Landroid/support/v4/view/ViewPager;->c:I

    invoke-virtual {v5, v6}, Lek;->getPageWidth(I)F
...
.method private final a(IZZI)V
    ...
    .line 126
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    invoke-virtual {v0}, Lek;->getCount()I
...
.method private final a(Lfc;ILfc;)V
    .locals 11
    ...
    invoke-virtual {v1}, Lek;->getCount()I
    ...
    .line 406
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    invoke-virtual {v4, v2}, Lek;->getPageWidth(I)F
    ...
    .line 434
    iget-object v8, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    add-int/lit8 v2, v1, -0x1

    invoke-virtual {v8, v1}, Lek;->getPageWidth(I)F
...
.method private final a(F)Z
    ...
    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    invoke-virtual {v9}, Lek;->getCount()I
...
.method private final b(Landroid/view/View;)Lfc;
    .locals 2
    ...
    .line 499
    :cond_2
    invoke-direct {p0, p1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lfc;
...
.method private final c()V
    ...
    invoke-direct {v0, p0}, Lfe;-><init>(Landroid/support/v4/view/ViewPager;)V

    invoke-static {p0, v0}, Lem;->a(Landroid/view/View;Ldq;)V
    ...
    invoke-direct {v0, p0}, Ldoa;-><init>(Landroid/support/v4/view/ViewPager;)V
...
.method private final c(I)V
    ...
    invoke-direct {v0, v2}, Landroid/support/v4/view/ViewPager;->d(I)Lfc;
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager;->b:Lek;
    ...
    invoke-virtual {v2, v0}, Lek;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->b:Lek;

    invoke-virtual {v4}, Lek;->getCount()I
    ...
    invoke-direct {v0, v2, v4}, Landroid/support/v4/view/ViewPager;->a(II)Lfc;
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->b:Lek;

    iget-object v2, v2, Lfc;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v14, v0, v8, v2}, Lek;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-direct {v0, v8, v2}, Landroid/support/v4/view/ViewPager;->a(II)Lfc;
    ...
    iget-object v10, v0, Landroid/support/v4/view/ViewPager;->b:Lek;

    iget-object v2, v2, Lfc;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v10, v0, v8, v2}, Lek;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-direct {v0, v8, v6}, Landroid/support/v4/view/ViewPager;->a(II)Lfc;
    ...
    invoke-direct {v0, v9, v7, v3}, Landroid/support/v4/view/ViewPager;->a(Lfc;ILfc;)V

    .line 355
    :cond_16
    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->b:Lek;
    ...
    iget-object v2, v9, Lfc;->a:Ljava/lang/Object;

    :goto_11
    move-object/from16 v0, p0

    invoke-virtual {v3, v0, v4, v2}, Lek;->setPrimaryItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v2, v0}, Lek;->finishUpdate(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {v0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lfc;
    ...
    invoke-direct {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/view/View;)Lfc;
    ...
    invoke-direct {v0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lfc;
...
.method private final e()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->V:Lfk;
...
.method private final e(I)Z
    ...
    .line 680
    :cond_2
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->j()Lfc;
...
.method private final f()V
    ...
    .line 718
    :cond_2
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->R:Lfg;
...
.method private final j()Lfc;
    ...
    .line 982
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Lfc;
    ...
    .line 985
    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    iget v7, v0, Lfc;->b:I

    invoke-virtual {v6, v7}, Lek;->getPageWidth(I)F
...
.method private final l()Z
    ...
    invoke-virtual {v2}, Lek;->getCount()I
...
.method public final a()V
    ...
    .line 239
    iget-object v7, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    iget-object v9, v0, Lfc;->a:Ljava/lang/Object;

    invoke-virtual {v7, v9}, Lek;->getItemPosition(Ljava/lang/Object;)I
    ...
    invoke-virtual {v4, p0}, Lek;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v6, p0, v7, v9}, Lek;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, p0}, Lek;->finishUpdate(Landroid/view/ViewGroup;)V
...
.method public final a(I)V
    ...
    .line 75
    invoke-interface {v0, p1}, Lff;->a(I)V
...
.method public final a(Lek;)V
    ...
    invoke-virtual {v0, v5}, Lek;->setViewPagerObserver(Landroid/database/DataSetObserver;)V

    .line 80
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    invoke-virtual {v0, p0}, Lek;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    .line 83
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    iget v4, v0, Lfc;->b:I

    iget-object v0, v0, Lfc;->a:Ljava/lang/Object;

    invoke-virtual {v3, p0, v4, v0}, Lek;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 97
    :cond_3
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->b:Lek;
    ...
    .line 100
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->o:Lfh;
    ...
    invoke-direct {v0, p0}, Lfh;-><init>(Landroid/support/v4/view/ViewPager;)V

    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->o:Lfh;

    .line 102
    :cond_4
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->b:Lek;

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->o:Lfh;

    invoke-virtual {v0, v1}, Lek;->setViewPagerObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {v0, v1, v3}, Lek;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
...
.method public final a(Lfg;)V
    ...
    .line 209
    .line 211
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->R:Lfg;
    ...
    .line 212
    :cond_0
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->R:Lfg;
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 1160
    invoke-direct {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lfc;
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    .line 1177
    invoke-direct {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lfc;
...
.method protected onLayout(ZIIII)V
    ...
    .line 637
    iget-boolean v10, v1, Lfd;->a:Z

    if-nez v10, :cond_2

    move-object/from16 v0, p0

    invoke-direct {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lfc;
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    .line 1193
    invoke-direct {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lfc;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object v1, p1, Lfi;->d:Landroid/os/Parcelable;

    iget-object v2, p1, Lfi;->e:Ljava/lang/ClassLoader;

    invoke-virtual {v0, v1, v2}, Lek;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    .line 468
    iget-object v0, p1, Lfi;->d:Landroid/os/Parcelable;

    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->k:Landroid/os/Parcelable;

    .line 469
    iget-object v0, p1, Lfi;->e:Ljava/lang/ClassLoader;
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lfi;-><init>(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0}, Lek;->saveState()Landroid/os/Parcelable;

    move-result-object v0

    iput-object v0, v1, Lfi;->d:Landroid/os/Parcelable;
...
.method protected onSizeChanged(IIII)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/view/ViewPager;->d(I)Lfc;
