...
# virtual methods
.method final callOnLoadFinished(Lbb;Ljava/lang/Object;)V
    .locals 5
    ...
    invoke-static {p2, v3}, Lkk;->a(Ljava/lang/Object;Ljava/lang/StringBuilder;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoadFinished(Lbb;Ljava/lang/Object;)V
    :try_end_0
...
.method final cancel()Z
    ...
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbb;
    ...
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbb;

    invoke-virtual {p0, v1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->onLoadCanceled(Lbb;)V
...
.method final destroy()V
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbb;

    invoke-interface {v0, v3}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoaderReset(Lbb;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0, p0}, Lbb;->a(Lbd;)V

    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbb;

    invoke-virtual {v0, p0}, Lbb;->a(Lbc;)V

    :cond_3
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbb;

    iput-boolean v5, v0, Lbb;->i:Z

    iput-boolean v4, v0, Lbb;->g:Z

    iput-boolean v4, v0, Lbb;->h:Z

    iput-boolean v4, v0, Lbb;->j:Z
...
.method public final dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2, p3, p4}, Lbb;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method final finishRetain()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Lbb;Ljava/lang/Object;)V

    :cond_2
    return-void
.end method

.method public final onLoadCanceled(Lbb;)V
    .locals 5
    ...
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Ldm;
    ...
    invoke-static {v3, v4, v2}, Lcx;->a([III)I

    move-result v2

    if-ltz v2, :cond_3

    iget-object v3, v0, Ldm;->d:[Ljava/lang/Object;

    aget-object v3, v3, v2

    sget-object v4, Ldm;->a:Ljava/lang/Object;
    ...
    iget-object v2, v2, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Ldm;

    iget v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mId:I

    invoke-virtual {v2, v3, v1}, Ldm;->a(ILjava/lang/Object;)V
...
.method public final onLoadComplete(Lbb;Ljava/lang/Object;)V
    .locals 6
    ...
    iget-object v1, v1, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Ldm;

    iget v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mId:I

    iget-object v3, v1, Ldm;->c:[I
    ...
    iget-object v3, v1, Ldm;->d:[Ljava/lang/Object;
    ...
    :cond_4
    iget-object v1, v1, Ldm;->d:[Ljava/lang/Object;
    ...
    invoke-virtual {v2, v3, v0}, Ldm;->a(ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Lbb;Ljava/lang/Object;)V

    :cond_9
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->this$0:Landroid/support/v4/app/LoaderManagerImpl;

    iget-object v1, v1, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Ldm;
    ...
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Ldm;

    iget v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mId:I

    iget-object v2, v0, Ldm;->c:[I

    iget v3, v0, Ldm;->e:I

    invoke-static {v2, v3, v1}, Lcx;->a([III)I

    move-result v1

    if-ltz v1, :cond_b

    iget-object v2, v0, Ldm;->d:[Ljava/lang/Object;

    aget-object v2, v2, v1

    sget-object v3, Ldm;->a:Ljava/lang/Object;
    ...
    :cond_c
    iget-object v0, v1, Ldm;->d:[Ljava/lang/Object;
...
.method final start()V
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Lbb;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbb;
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbb;
    ...
    :cond_5
    iput-object p0, v0, Lbb;->d:Lbd;

    iput v1, v0, Lbb;->c:I

    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbb;

    iget-object v1, v0, Lbb;->e:Lbc;
    ...
    iput-boolean v3, v0, Lbb;->g:Z

    iput-boolean v4, v0, Lbb;->i:Z

    iput-boolean v4, v0, Lbb;->h:Z

    invoke-virtual {v0}, Lbb;->e()V
