...
.field public final mInactiveLoaders:Ldm;

.field public final mLoaders:Ldm;
...
.method constructor <init>(Ljava/lang/String;Landroid/support/v4/app/FragmentHostCallback;Z)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Ldm;

    new-instance v0, Ldm;

    invoke-direct {v0}, Ldm;-><init>()V

    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Ldm;
...
.method private createLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;
    ...
    invoke-interface {p3, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Lbb;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbb;
...
.method public destroyLoader(I)V
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Ldm;

    invoke-virtual {v0, p1}, Ldm;->e(I)I
    ...
    invoke-virtual {v0, v1}, Ldm;->d(I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;

    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Ldm;

    invoke-virtual {v2, v1}, Ldm;->b(I)V

    invoke-virtual {v0}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->destroy()V

    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Ldm;
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Ldm;
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v4, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Ldm;

    invoke-virtual {v4, v1}, Ldm;->c(I)I
    ...
    invoke-virtual {v0, v2}, Ldm;->d(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Ldm;

    invoke-virtual {v3, v2}, Ldm;->c(I)I
...
.method public getLoader(I)Lbb;
    ...
    invoke-static {v2, v3, p1}, Lcx;->a([III)I
    ...
    iget-object v1, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbb;
...
.method public initLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Lbb;
    .locals 4
    ...
    iget-object v1, v0, Ldm;->c:[I

    iget v2, v0, Ldm;->e:I

    invoke-static {v1, v2, p1}, Lcx;->a([III)I
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Lbb;Ljava/lang/Object;)V

    :cond_4
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbb;
...
.method installLoader(Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;)V
    ...
    invoke-virtual {v0, v1, p1}, Ldm;->a(ILjava/lang/Object;)V
...
.method public restartLoader(ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Lbb;
    .locals 6
    ...
    invoke-static {v1, v3, p1}, Lcx;->a([III)I
    ...
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Ldm;

    iget-object v3, v1, Ldm;->c:[I

    iget v4, v1, Ldm;->e:I

    invoke-static {v3, v4, p1}, Lcx;->a([III)I

    move-result v3

    if-ltz v3, :cond_3

    iget-object v4, v1, Ldm;->d:[Ljava/lang/Object;
    ...
    invoke-virtual {v1, p1, v0}, Ldm;->a(ILjava/lang/Object;)V
    ...
    :cond_a
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Ldm;

    invoke-virtual {v1, p1, v2}, Ldm;->a(ILjava/lang/Object;)V
