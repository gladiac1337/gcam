...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lafg;->a:[Landroid/graphics/Bitmap$Config;
    ...
    sput-object v0, Lafg;->b:[Landroid/graphics/Bitmap$Config;
    ...
    sput-object v0, Lafg;->c:[Landroid/graphics/Bitmap$Config;
    ...
    sput-object v0, Lafg;->d:[Landroid/graphics/Bitmap$Config;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lafg;->e:Lafj;

    new-instance v0, Laex;

    invoke-direct {v0}, Laex;-><init>()V

    iput-object v0, p0, Lafg;->f:Laex;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lafg;->g:Ljava/util/Map;
...
.method private final a(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
    ...
    iget-object v0, p0, Lafg;->g:Ljava/util/Map;
    ...
    iget-object v1, p0, Lafg;->g:Ljava/util/Map;
...
.method private final a(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {p0, v0}, Lafg;->a(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
    ...
    invoke-virtual {p0, p2}, Lafg;->b(Landroid/graphics/Bitmap;)Ljava/lang/String;
...
.method public final a()Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v1, v0}, Lafg;->a(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
...
.method public final a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p3}, Laos;->a(IILandroid/graphics/Bitmap$Config;)I

    move-result v4

    iget-object v0, p0, Lafg;->e:Lafj;

    invoke-virtual {v0, v4, p3}, Lafj;->a(ILandroid/graphics/Bitmap$Config;)Lafi;
    ...
    invoke-direct {p0, v6}, Lafg;->a(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
    ...
    :cond_0
    iget-object v1, p0, Lafg;->e:Lafj;

    invoke-virtual {v1, v2}, Lafj;->a(Laff;)V
    ...
    invoke-virtual {v1, v0, v6}, Lafj;->a(ILandroid/graphics/Bitmap$Config;)Lafi;
    ...
    invoke-virtual {v0, v1}, Laex;->a(Laff;)Ljava/lang/Object;
    ...
    :pswitch_0
    sget-object v0, Lafg;->a:[Landroid/graphics/Bitmap$Config;
    ...
    :pswitch_1
    sget-object v0, Lafg;->b:[Landroid/graphics/Bitmap$Config;
    ...
    :pswitch_2
    sget-object v0, Lafg;->c:[Landroid/graphics/Bitmap$Config;
    ...
    :pswitch_3
    sget-object v0, Lafg;->d:[Landroid/graphics/Bitmap$Config;
...
.method public final a(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v1, v0, v2}, Lafj;->a(ILandroid/graphics/Bitmap$Config;)Lafi;

    move-result-object v1

    iget-object v0, p0, Lafg;->f:Laex;

    invoke-virtual {v0, v1, p1}, Laex;->a(Laff;Ljava/lang/Object;)V
...
.method public final b(IILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
    ...
    invoke-static {v0, p3}, Lafg;->a(ILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
...
.method public final b(Landroid/graphics/Bitmap;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lafg;->a(ILandroid/graphics/Bitmap$Config;)Ljava/lang/String;
