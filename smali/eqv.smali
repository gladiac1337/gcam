...
.method public constructor <init>(Lgsf;Lgdo;Lbhm;)V
    .locals 3

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Leqv;->b:Lgsf;

    iput-object p2, p0, Leqv;->c:Lgdo;

    invoke-virtual {p3}, Lbhm;->a()Ljava/lang/String;
    ...
    iget-object v1, p3, Lbhm;->a:Landroid/content/ContentResolver;
...
# virtual methods
.method public final a(Lifr;Lift;)Libx;
    .locals 9
    ...
    :cond_0
    :goto_1
    iget-object v5, p0, Leqv;->b:Lgsf;

    const-string v6, "default_scope"

    invoke-virtual {v5, v6, v0}, Lgsf;->f(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v6

    if-eqz v6, :cond_9

    iget-object v2, p0, Leqv;->b:Lgsf;

    const-string v5, "default_scope"

    invoke-virtual {v2, v5, v0}, Lgsf;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Liby;->a(Ljava/lang/String;)Libx;
    ...
    :goto_3
    iget-object v7, p0, Leqv;->c:Lgdo;

    invoke-virtual {v7, p1}, Lgdo;->a(Lifr;)Lgdm;

    move-result-object v7

    const/16 v8, 0x100

    invoke-interface {v7, v8}, Lgdm;->a(I)Ljava/util/List;
    ...
    iget-object v1, p0, Leqv;->b:Lgsf;

    const-string v2, "default_scope"

    invoke-static {v5}, Liby;->a(Libx;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1, v2, v0, v3}, Lgsf;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5, v7}, Lequ;->a(Libx;Ljava/util/Set;)Z
