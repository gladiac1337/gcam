...
.method public constructor <init>(Landroid/widget/ImageView;)V
    ...
    iput-object p1, p0, Loj;->a:Landroid/widget/ImageView;
...
.method public final a(I)V
    ...
    iget-object v0, p0, Loj;->a:Landroid/widget/ImageView;
    ...
    invoke-static {v0}, Lpv;->a(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    iget-object v1, p0, Loj;->a:Landroid/widget/ImageView;
...
.method public final a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, v2}, Lkt;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v2, p0, Loj;->a:Landroid/widget/ImageView;
    ...
    sget-object v3, Lhy;->a:Lhz;

    invoke-virtual {v3, v0, v2}, Lhz;->a(Landroid/widget/ImageView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v3, v0, v2}, Lhz;->a(Landroid/widget/ImageView;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method final d()V
    ...
    invoke-static {v3}, Lpv;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v4, p0, Loj;->a:Landroid/widget/ImageView;

    sget-object v5, Lhy;->a:Lhz;

    invoke-virtual {v5, v4}, Lhz;->a(Landroid/widget/ImageView;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v5, v4}, Lhz;->b(Landroid/widget/ImageView;)Landroid/graphics/PorterDuff$Mode;
