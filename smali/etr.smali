...
.method public constructor <init>(Lbtw;Lgrp;Lgzo;)V
    .locals 2
    ...
    iput-object v0, p0, Letr;->n:Lgrp;

    iput-object p3, p0, Letr;->o:Lgzo;
...
.method private final a(Landroid/net/Uri;Z)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2}, Lfuw;->a(Ljava/io/InputStream;)Lxb;
    :try_end_0
    ...
    iget-object v0, p0, Letr;->l:Lbtw;

    invoke-interface {v0}, Lbtw;->y()Landroid/view/WindowManager;
...
.method static synthetic a(Letr;)Lgrp;
    .locals 1

    iget-object v0, p0, Letr;->n:Lgrp;
...
.method private final a(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    invoke-interface {v0}, Lbtw;->w()Landroid/content/ContentResolver;
