...
.method public constructor <init>(Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;)V
    ...
    iput-object p1, p0, Leef;->a:Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;
...
.method public final run()V
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Leef;->a:Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;

    iget-object v0, v0, Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;->k:Lgch;

    invoke-virtual {v0}, Lgch;->a()Lgcg;

    move-result-object v0

    if-eqz v0, :cond_3

    iget-object v1, p0, Leef;->a:Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;
    ...
    :try_start_1
    iget-object v2, p0, Leef;->a:Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;

    iput-object v0, v2, Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;->d:Lgcg;
    ...
    iget-object v2, v2, Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;->d:Lgcg;

    invoke-interface {v2}, Lgcg;->a()V
    ...
    iget-object v1, v1, Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;->o:Lhic;

    new-instance v2, Leeg;

    invoke-direct {v2, v0}, Leeg;-><init>(Ljava/lang/Exception;)V
    ...
    invoke-interface {v0}, Lgcg;->c()Lgcf;

    move-result-object v2

    if-eqz v2, :cond_2

    invoke-interface {v2, v1}, Lgcf;->a(Lgci;)V
    ...
    invoke-interface {v0, v1}, Lgcg;->a(Landroid/content/Context;)V
    ...
    iput-object v2, v0, Lcom/google/android/apps/camera/legacy/app/processing/ProcessingService;->d:Lgcg;
