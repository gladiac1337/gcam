...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lfno;->g:Ljava/lang/String;
...
.method public constructor <init>(Labe;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lfno;->h:Landroid/graphics/SurfaceTexture;

    .line 4
    const/4 v0, 0x0

    iput-boolean v0, p0, Lfno;->e:Z

    .line 5
    iput-object p1, p0, Lfno;->b:Labe;

    .line 6
    iput-object p2, p0, Lfno;->a:Landroid/os/Handler;
...
.method public final declared-synchronized a(Landroid/view/WindowManager;Landroid/content/Context;Labd;ZI)Lact;
    ...
    :try_start_0
    iput-object p3, p0, Lfno;->c:Labd;

    .line 9
    const/4 v1, 0x1

    iput-boolean v1, p0, Lfno;->d:Z

    .line 10
    iget-object v1, p0, Lfno;->b:Labe;

    if-nez v1, :cond_0

    .line 11
    sget-object v1, Lfno;->g:Ljava/lang/String;
    ...
    .line 21
    invoke-static {p2, v1}, Lfnr;->a(Landroid/content/Context;Labw;)Labz;
    ...
    .line 26
    invoke-static {v1}, Lfnr;->b(Labw;)Laby;
    ...
    .line 28
    invoke-static {v1}, Lfnr;->a(Labw;)Laca;
    ...
    .line 32
    invoke-static {v1, p5}, Lfnp;->a(Labw;I)Lfnq;
    ...
    iput-object v3, p0, Lfno;->f:Lact;

    .line 34
    iget-object v3, p0, Lfno;->f:Lact;

    invoke-virtual {v2, v3}, Lacl;->a(Lact;)Z

    .line 35
    invoke-static {v1, v2}, Lfnr;->a(Labw;Lacl;)V
    ...
    iget-object v1, p0, Lfno;->h:Landroid/graphics/SurfaceTexture;

    invoke-virtual {v0, v1}, Labe;->a(Landroid/graphics/SurfaceTexture;)V

    .line 57
    iget-boolean v0, p0, Lfno;->d:Z
    ...
    iget-object v1, p0, Lfno;->f:Lact;

    iget-object v2, p0, Lfno;->a:Landroid/os/Handler;

    iget-object v3, p0, Lfno;->c:Labd;

    invoke-static {v0, v1, v2, v3}, Lfnr;->a(Labe;Lact;Landroid/os/Handler;Labd;)V

    .line 60
    :goto_2
    iget-object v0, p0, Lfno;->f:Lact;
    ...
    iget-object v1, p0, Lfno;->a:Landroid/os/Handler;

    iget-object v2, p0, Lfno;->c:Labd;
