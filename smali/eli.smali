...
.method public constructor <init>(Lgft;Lfss;Lcom/google/android/apps/camera/config/GservicesHelper;)V
    .locals 3

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Leli;->b:Lgft;

    iput-object p2, p0, Leli;->c:Lfss;
...
# virtual methods
.method public final a(Lhmp;Lhmr;)Lhja;
    .locals 9
    ...
    :cond_0
    :goto_1
    iget-object v5, p0, Leli;->b:Lgft;

    const-string v6, "default_scope"

    invoke-virtual {v5, v6, v0}, Lgft;->f(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v6

    if-eqz v6, :cond_9

    iget-object v2, p0, Leli;->b:Lgft;

    const-string v5, "default_scope"

    invoke-virtual {v2, v5, v0}, Lgft;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Lkk;->q(Ljava/lang/String;)Lhja;
    ...
    :goto_3
    iget-object v7, p0, Leli;->c:Lfss;

    invoke-virtual {v7, p1}, Lfss;->a(Lhmp;)Lfsq;

    move-result-object v7

    const/16 v8, 0x100

    invoke-interface {v7, v8}, Lfsq;->a(I)Ljava/util/List;
    ...
    :cond_2
    invoke-static {v7, v1}, Lkk;->a(Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v1, p0, Leli;->b:Lgft;

    const-string v2, "default_scope"

    invoke-static {v5}, Lkk;->a(Lhja;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1, v2, v0, v3}, Lgft;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Leli;->e:Ljava/lang/String;
    ...
    invoke-static {v5, v7}, Lkk;->a(Lhja;Ljava/util/Set;)Z
